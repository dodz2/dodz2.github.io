...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function zo(e,t,n){let r=new Float32Array(To),i=new q(0,1,0);return new da({name:`SphericalGaussianBlur`,defines:{n:To,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Bo(){return new da({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ho(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(){return new da({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ho(),fragmentShader:`
...
`)}var mc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function hc(e,t){let n=mc[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var gc=new q;function _c(){return Y.getLuminanceCoefficients(gc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${gc.x.toFixed(4)}, ${gc.y.toFixed(4)}, ${gc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=oc(i,i.VERTEX_SHADER,y),S=oc(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=fc(i,x,`vertex`),n=fc(i,S,`fragment`);W(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
}`,vl=class{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){let n=new $i(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){let t=e.cameras[0].viewport,n=new da({vertexShader:gl,fragmentShader:_l,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Ti(new ta(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}},yl=class extends Jt{constructor(e,t){super();let n=this,r=null,i=1,a=null,o=`local-floor`,s=1,c=null,l=null,u=null,d=null,f=null,p=null,m=typeof XRWebGLBinding<`u`,h=new vl,g={},_=t.getContextAttributes(),v=null,y=null,b=[],x=[],S=new K,C=null,w=new Ha;w.viewport=new xn;let T=new Ha;T.viewport=new xn;let E=[w,T],D=new Xa,O=null,k=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(e){let t=b[e];return t===void 0&&(t=new nr,b[e]=t),t.getTargetRaySpace()},this.getControllerGrip=function(e){let t=b[e];return t===void 0&&(t=new nr,b[e]=t),t.getGripSpace()},this.getHand=function(e){let t=b[e];return t===void 0&&(t=new nr,b[e]=t),t.getHandSpace()};function A(e){let t=x.indexOf(e.inputSource);if(t===-1)return;let n=b[t];n!==void 0&&(n.update(e.inputSource,e.frame,c||a),n.dispatchEvent({type:e.type,data:e.inputSource}))}function ee(){r.removeEventListener(`select`,A),r.removeEventListener(`selectstart`,A),r.removeEventListener(`selectend`,A),r.removeEventListener(`squeeze`,A),r.removeEventListener(`squeezestart`,A),r.removeEventListener(`squeezeend`,A),r.removeEventListener(`end`,ee),r.removeEventListener(`inputsourceschange`,te);for(let e=0;e<b.length;e++){let t=x[e];t!==null&&(x[e]=null,b[e].disconnect(t))}O=null,k=null,h.reset();for(let e in g)delete g[e];e.setRenderTarget(v),f=null,d=null,u=null,r=null,y=null,oe.stop(),n.isPresenting=!1,e.setPixelRatio(C),e.setSize(S.width,S.height,!1),n.dispatchEvent({type:`sessionend`})}this.setFramebufferScaleFactor=function(e){i=e,n.isPresenting===!0&&U(`WebXRManager: Cannot change framebuffer scale while presenting.`)},this.setReferenceSpaceType=function(e){o=e,n.isPresenting===!0&&U(`WebXRManager: Cannot change reference space type while presenting.`)},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(e){c=e},this.getBaseLayer=function(){return d===null?f:d},this.getBinding=function(){return u===null&&m&&(u=new XRWebGLBinding(r,t)),u},this.getFrame=function(){return p},this.getSession=function(){return r},this.setSession=async function(l){if(r=l,r!==null){if(v=e.getRenderTarget(),r.addEventListener(`select`,A),r.addEventListener(`selectstart`,A),r.addEventListener(`selectend`,A),r.addEventListener(`squeeze`,A),r.addEventListener(`squeezestart`,A),r.addEventListener(`squeezeend`,A),r.addEventListener(`end`,ee),r.addEventListener(`inputsourceschange`,te),_.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(S),m&&`createProjectionLayer`in XRWebGLBinding.prototype){let n=null,a=null,o=null;_.depth&&(o=_.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,n=_.stencil?Fe:Pe,a=_.stencil?Ae:Ee);let s={colorFormat:t.RGBA8,depthFormat:o,scaleFactor:i};u=this.getBinding(),d=u.createProjectionLayer(s),r.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),y=new Cn(d.textureWidth,d.textureHeight,{format:Ne,type:Ce,depthTexture:new Zi(d.textureWidth,d.textureHeight,a,void 0,void 0,void 0,void 0,void 0,void 0,n),stencilBuffer:_.stencil,colorSpace:e.outputColorSpace,samples:_.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{let n={antialias:_.antialias,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:i};f=new XRWebGLLayer(r,t,n),r.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new Cn(f.framebufferWidth,f.framebufferHeight,{format:Ne,type:Ce,colorSpace:e.outputColorSpace,stencilBuffer:_.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(s),c=null,a=await r.requestReferenceSpace(o),oe.setContext(r),oe.start(),n.isPresenting=!0,n.dispatchEvent({type:`sessionstart`})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return h.getDepthTexture()};function te(e){for(let t=0;t<e.removed.length;t++){let n=e.removed[t],r=x.indexOf(n);r>=0&&(x[r]=null,b[r].disconnect(n))}for(let t=0;t<e.added.length;t++){let n=e.added[t],r=x.indexOf(n);if(r===-1){for(let e=0;e<b.length;e++)if(e>=x.length){x.push(n),r=e;break}else if(x[e]===null){x[e]=n,r=e;break}if(r===-1)break}let i=b[r];i&&i.connect(n)}}let j=new q,M=new q;function ne(e,t,n){j.setFromMatrixPosition(t.matrixWorld),M.setFromMatrixPosition(n.matrixWorld);let r=j.distanceTo(M),i=t.projectionMatrix.elements,a=n.projectionMatrix.elements,o=i[14]/(i[10]-1),s=i[14]/(i[10]+1),c=(i[9]+1)/i[5],l=(i[9]-1)/i[5],u=(i[8]-1)/i[0],d=(a[8]+1)/a[0],f=o*u,p=o*d,m=r/(-u+d),h=m*-u;if(t.matrixWorld.decompose(e.position,e.quaternion,e.scale),e.translateX(h),e.translateZ(m),e.matrixWorld.compose(e.position,e.quaternion,e.scale),e.matrixWorldInverse.copy(e.matrixWorld).invert(),i[10]===-1)e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse);else{let t=o+m,n=s+m,i=f-h,a=p+(r-h),u=c*s/n*t,d=l*s/n*t;e.projectionMatrix.makePerspective(i,a,u,d,t,n),e.projectionMatrixInverse.copy(e.projectionMatrix).invert()}}function N(e,t){t===null?e.matrixWorld.copy(e.matrix):e.matrixWorld.multiplyMatrices(t.matrixWorld,e.matrix),e.matrixWorldInverse.copy(e.matrixWorld).invert()}this.updateCamera=function(e){if(r===null)return;let t=e.near,n=e.far;h.texture!==null&&(h.depthNear>0&&(t=h.depthNear),h.depthFar>0&&(n=h.depthFar)),D.near=T.near=w.near=t,D.far=T.far=w.far=n,(O!==D.near||k!==D.far)&&(r.updateRenderState({depthNear:D.near,depthFar:D.far}),O=D.near,k=D.far),D.layers.mask=e.layers.mask|6,w.layers.mask=D.layers.mask&-5,T.layers.mask=D.layers.mask&-3;let i=e.parent,a=D.cameras;N(D,i);for(let e=0;e<a.length;e++)N(a[e],i);a.length===2?ne(D,w,T):D.projectionMatrix.copy(w.projectionMatrix),re(e,D,i)};function re(e,t,n){n===null?e.matrix.copy(t.matrixWorld):(e.matrix.copy(n.matrixWorld),e.matrix.invert(),e.matrix.multiply(t.matrixWorld)),e.matrix.decompose(e.position,e.quaternion,e.scale),e.updateMatrixWorld(!0),e.projectionMatrix.copy(t.projectionMatrix),e.projectionMatrixInverse.copy(t.projectionMatrixInverse),e.isPerspectiveCamera&&(e.fov=Zt*2*Math.atan(1/e.projectionMatrix.elements[5]),e.zoom=1)}this.getCamera=function(){return D},this.getFoveation=function(){if(d!==null||f!==null)return s},this.setFoveation=function(e){s=e,d!==null&&(d.fixedFoveation=e),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=e)},this.hasDepthSensing=function(){return h.texture!==null},this.getDepthSensingMesh=function(){return h.getMesh(D)},this.getCameraTexture=function(e){return g[e]};let ie=null;function ae(t,i){if(l=i.getViewerPose(c||a),p=i,l!==null){let t=l.views;f!==null&&(e.setRenderTargetFramebuffer(y,f.framebuffer),e.setRenderTarget(y));let i=!1;t.length!==D.cameras.length&&(D.cameras.length=0,i=!0);for(let n=0;n<t.length;n++){let r=t[n],a=null;if(f!==null)a=f.getViewport(r);else{let t=u.getViewSubImage(d,r);a=t.viewport,n===0&&(e.setRenderTargetTextures(y,t.colorTexture,t.depthStencilTexture),e.setRenderTarget(y))}let o=E[n];o===void 0&&(o=new Ha,o.layers.enable(n),o.viewport=new xn,E[n]=o),o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.quaternion,o.scale),o.projectionMatrix.fromArray(r.projectionMatrix),o.projectionMatrixInverse.copy(o.projectionMatrix).invert(),o.viewport.set(a.x,a.y,a.width,a.height),n===0&&(D.matrix.copy(o.matrix),D.matrix.decompose(D.position,D.quaternion,D.scale)),i===!0&&D.cameras.push(o)}let a=r.enabledFeatures;if(a&&a.includes(`depth-sensing`)&&r.depthUsage==`gpu-optimized`&&m){u=n.getBinding();let e=u.getDepthInformation(t[0]);e&&e.isValid&&e.texture&&h.init(e,r.renderState)}if(a&&a.includes(`camera-access`)&&m){e.state.unbindTexture(),u=n.getBinding();for(let e=0;e<t.length;e++){let n=t[e].camera;if(n){let e=g[n];e||(e=new $i,g[n]=e);let t=u.getCameraImage(n);e.sourceTexture=t}}}}for(let e=0;e<b.length;e++){let t=x[e],n=b[e];t!==null&&n!==void 0&&n.update(t,i,c||a)}ie&&ie(t,i),i.detectedPlanes&&n.dispatchEvent({type:`planesdetected`,data:i}),p=null}let oe=new fo;oe.setAnimationLoop(ae),this.setAnimationLoop=function(e){ie=e},this.dispose=function(){}}},bl=new En,xl=new J;xl.set(-1,0,0,0,1,0,0,0,1);function Sl(e,t){function n(e,t){e.matrixAutoUpdate===!0&&e.updateMatrix(),t.value.copy(e.matrix)}function r(t,n){n.color.getRGB(t.fogColor.value,sa(e)),n.isFog?(t.fogNear.value=n.near,t.fogFar.value=n.far):n.isFogExp2&&(t.fogDensity.value=n.density)}function i(e,t,n,r,i){t.isNodeMaterial?t.uniformsNeedUpdate=!1:t.isMeshBasicMaterial?a(e,t):t.isMeshLambertMaterial?(a(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshToonMaterial?(a(e,t),d(e,t)):t.isMeshPhongMaterial?(a(e,t),u(e,t),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)):t.isMeshStandardMaterial?(a(e,t),f(e,t),t.isMeshPhysicalMaterial&&p(e,t,i)):t.isMeshMatcapMaterial?(a(e,t),m(e,t)):t.isMeshDepthMaterial?a(e,t):t.isMeshDistanceMaterial?(a(e,t),h(e,t)):t.isMeshNormalMaterial?a(e,t):t.isLineBasicMaterial?(o(e,t),t.isLineDashedMaterial&&s(e,t)):t.isPointsMaterial?c(e,t,n,r):t.isSpriteMaterial?l(e,t):t.isShadowMaterial?(e.color.value.copy(t.color),e.opacity.value=t.opacity):t.isShaderMaterial&&(t.uniformsNeedUpdate=!1)}function a(e,r){e.opacity.value=r.opacity,r.color&&e.diffuse.value.copy(r.color),r.emissive&&e.emissive.value.copy(r.emissive).multiplyScalar(r.emissiveIntensity),r.map&&(e.map.value=r.map,n(r.map,e.mapTransform)),r.alphaMap&&(e.alphaMap.value=r.alphaMap,n(r.alphaMap,e.alphaMapTransform)),r.bumpMap&&(e.bumpMap.value=r.bumpMap,n(r.bumpMap,e.bumpMapTransform),e.bumpScale.value=r.bumpScale,r.side===1&&(e.bumpScale.value*=-1)),r.normalMap&&(e.normalMap.value=r.normalMap,n(r.normalMap,e.normalMapTransform),e.normalScale.value.copy(r.normalScale),r.side===1&&e.normalScale.value.negate()),r.displacementMap&&(e.displacementMap.value=r.displacementMap,n(r.displacementMap,e.displacementMapTransform),e.displacementScale.value=r.displacementScale,e.displacementBias.value=r.displacementBias),r.emissiveMap&&(e.emissiveMap.value=r.emissiveMap,n(r.emissiveMap,e.emissiveMapTransform)),r.specularMap&&(e.specularMap.value=r.specularMap,n(r.specularMap,e.specularMapTransform)),r.alphaTest>0&&(e.alphaTest.value=r.alphaTest);let i=t.get(r),a=i.envMap,o=i.envMapRotation;a&&(e.envMap.value=a,e.envMapRotation.value.setFromMatrix4(bl.makeRotationFromEuler(o)).transpose(),a.isCubeTexture&&a.isRenderTargetTexture===!1&&e.envMapRotation.value.premultiply(xl),e.reflectivity.value=r.reflectivity,e.ior.value=r.ior,e.refractionRatio.value=r.refractionRatio),r.lightMap&&(e.lightMap.value=r.lightMap,e.lightMapIntensity.value=r.lightMapIntensity,n(r.lightMap,e.lightMapTransform)),r.aoMap&&(e.aoMap.value=r.aoMap,e.aoMapIntensity.value=r.aoMapIntensity,n(r.aoMap,e.aoMapTransform))}function o(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform))}function s(e,t){e.dashSize.value=t.dashSize,e.totalSize.value=t.dashSize+t.gapSize,e.scale.value=t.scale}function c(e,t,r,i){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.size.value=t.size*r,e.scale.value=i*.5,t.map&&(e.map.value=t.map,n(t.map,e.uvTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function l(e,t){e.diffuse.value.copy(t.color),e.opacity.value=t.opacity,e.rotation.value=t.rotation,t.map&&(e.map.value=t.map,n(t.map,e.mapTransform)),t.alphaMap&&(e.alphaMap.value=t.alphaMap,n(t.alphaMap,e.alphaMapTransform)),t.alphaTest>0&&(e.alphaTest.value=t.alphaTest)}function u(e,t){e.specular.value.copy(t.specular),e.shininess.value=Math.max(t.shininess,1e-4)}function d(e,t){t.gradientMap&&(e.gradientMap.value=t.gradientMap)}function f(e,t){e.metalness.value=t.metalness,t.metalnessMap&&(e.metalnessMap.value=t.metalnessMap,n(t.metalnessMap,e.metalnessMapTransform)),e.roughness.value=t.roughness,t.roughnessMap&&(e.roughnessMap.value=t.roughnessMap,n(t.roughnessMap,e.roughnessMapTransform)),t.envMap&&(e.envMapIntensity.value=t.envMapIntensity)}function p(e,t,r){e.ior.value=t.ior,t.sheen>0&&(e.sheenColor.value.copy(t.sheenColor).multiplyScalar(t.sheen),e.sheenRoughness.value=t.sheenRoughness,t.sheenColorMap&&(e.sheenColorMap.value=t.sheenColorMap,n(t.sheenColorMap,e.sheenColorMapTransform)),t.sheenRoughnessMap&&(e.sheenRoughnessMap.value=t.sheenRoughnessMap,n(t.sheenRoughnessMap,e.sheenRoughnessMapTransform))),t.clearcoat>0&&(e.clearcoat.value=t.clearcoat,e.clearcoatRoughness.value=t.clearcoatRoughness,t.clearcoatMap&&(e.clearcoatMap.value=t.clearcoatMap,n(t.clearcoatMap,e.clearcoatMapTransform)),t.clearcoatRoughnessMap&&(e.clearcoatRoughnessMap.value=t.clearcoatRoughnessMap,n(t.clearcoatRoughnessMap,e.clearcoatRoughnessMapTransform)),t.clearcoatNormalMap&&(e.clearcoatNormalMap.value=t.clearcoatNormalMap,n(t.clearcoatNormalMap,e.clearcoatNormalMapTransform),e.clearcoatNormalScale.value.copy(t.clearcoatNormalScale),t.side===1&&e.clearcoatNormalScale.value.negate())),t.dispersion>0&&(e.dispersion.value=t.dispersion),t.iridescence>0&&(e.iridescence.value=t.iridescence,e.iridescenceIOR.value=t.iridescenceIOR,e.iridescenceThicknessMinimum.value=t.iridescenceThicknessRange[0],e.iridescenceThicknessMaximum.value=t.iridescenceThicknessRange[1],t.iridescenceMap&&(e.iridescenceMap.value=t.iridescenceMap,n(t.iridescenceMap,e.iridescenceMapTransform)),t.iridescenceThicknessMap&&(e.iridescenceThicknessMap.value=t.iridescenceThicknessMap,n(t.iridescenceThicknessMap,e.iridescenceThicknessMapTransform))),t.transmission>0&&(e.transmission.value=t.transmission,e.transmissionSamplerMap.value=r.texture,e.transmissionSamplerSize.value.set(r.width,r.height),t.transmissionMap&&(e.transmissionMap.value=t.transmissionMap,n(t.transmissionMap,e.transmissionMapTransform)),e.thickness.value=t.thickness,t.thicknessMap&&(e.thicknessMap.value=t.thicknessMap,n(t.thicknessMap,e.thicknessMapTransform)),e.attenuationDistance.value=t.attenuationDistance,e.attenuationColor.value.copy(t.attenuationColor)),t.anisotropy>0&&(e.anisotropyVector.value.set(t.anisotropy*Math.cos(t.anisotropyRotation),t.anisotropy*Math.sin(t.anisotropyRotation)),t.anisotropyMap&&(e.anisotropyMap.value=t.anisotropyMap,n(t.anisotropyMap,e.anisotropyMapTransform))),e.specularIntensity.value=t.specularIntensity,e.specularColor.value.copy(t.specularColor),t.specularColorMap&&(e.specularColorMap.value=t.specularColorMap,n(t.specularColorMap,e.specularColorMapTransform)),t.specularIntensityMap&&(e.specularIntensityMap.value=t.specularIntensityMap,n(t.specularIntensityMap,e.specularIntensityMapTransform))}function m(e,t){t.matcap&&(e.matcap.value=t.matcap)}function h(e,n){let r=t.get(n).light;e.referencePosition.value.setFromMatrixPosition(r.matrixWorld),e.nearDistance.value=r.shadow.camera.near,e.farDistance.value=r.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:i}}function Cl(e,t,n,r){let i={},a={},o=[],s=e.getParameter(e.MAX_UNIFORM_BUFFER_BINDINGS);function c(e,t){let n=t.program;r.uniformBlockBinding(e,n)}function l(e,n){let o=i[e.id];o===void 0&&(g(e),o=u(e),i[e.id]=o,e.addEventListener(`dispose`,v));let s=n.program;r.updateUBOMapping(e,s);let c=t.render.frame;a[e.id]!==c&&(f(e),a[e.id]=c)}function u(t){let n=d();t.__bindingPointIndex=n;let r=e.createBuffer(),i=t.__size,a=t.usage;return e.bindBuffer(e.UNIFORM_BUFFER,r),e.bufferData(e.UNIFORM_BUFFER,i,a),e.bindBuffer(e.UNIFORM_BUFFER,null),e.bindBufferBase(e.UNIFORM_BUFFER,n,r),r}function d(){for(let e=0;e<s;e++)if(o.indexOf(e)===-1)return o.push(e),e;return W(`WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached.`),0}function f(t){let n=i[t.id],r=t.uniforms,a=t.__cache;e.bindBuffer(e.UNIFORM_BUFFER,n);for(let e=0,t=r.length;e<t;e++){let t=r[e];if(Array.isArray(t))for(let n=0,r=t.length;n<r;n++)p(t[n],e,n,a);else p(t,e,0,a)}e.bindBuffer(e.UNIFORM_BUFFER,null)}function p(t,n,r,i){if(h(t,n,r,i)===!0){let n=t.__offset,r=t.value;if(Array.isArray(r)){let e=0;for(let n=0;n<r.length;n++){let i=r[n],a=_(i);m(i,t.__data,e),typeof i!=`number`&&typeof i!=`boolean`&&!i.isMatrix3&&!ArrayBuffer.isView(i)&&(e+=a.storage/Float32Array.BYTES_PER_ELEMENT)}}else m(r,t.__data,0);e.bufferSubData(e.UNIFORM_BUFFER,n,t.__data)}}function m(e,t,n){typeof e==`number`||typeof e==`boolean`?t[0]=e:e.isMatrix3?(t[0]=e.elements[0],t[1]=e.elements[1],t[2]=e.elements[2],t[3]=0,t[4]=e.elements[3],t[5]=e.elements[4],t[6]=e.elements[5],t[7]=0,t[8]=e.elements[6],t[9]=e.elements[7],t[10]=e.elements[8],t[11]=0):ArrayBuffer.isView(e)?t.set(new e.constructor(e.buffer,e.byteOffset,t.length)):e.toArray(t,n)}function h(e,t,n,r){let i=e.value,a=t+`_`+n;if(r[a]===void 0)return r[a]=typeof i==`number`||typeof i==`boolean`?i:ArrayBuffer.isView(i)?i.slice():i.clone(),!0;{let e=r[a];if(typeof i==`number`||typeof i==`boolean`){if(e!==i)return r[a]=i,!0}else if(ArrayBuffer.isView(i))return!0;else if(e.equals(i)===!1)return e.copy(i),!0}return!1}function g(e){let t=e.uniforms,n=0;for(let e=0,r=t.length;e<r;e++){let r=Array.isArray(t[e])?t[e]:[t[e]];for(let e=0,t=r.length;e<t;e++){let t=r[e],i=Array.isArray(t.value)?t.value:[t.value];for(let e=0,r=i.length;e<r;e++){let r=i[e],a=_(r),o=n%16,s=o%a.boundary,c=o+s;n+=s,c!==0&&16-c<a.storage&&(n+=16-c),t.__data=new Float32Array(a.storage/Float32Array.BYTES_PER_ELEMENT),t.__offset=n,n+=a.storage}}}let r=n%16;return r>0&&(n+=16-r),e.__size=n,e.__cache={},this}function _(e){let t={boundary:0,storage:0};return typeof e==`number`||typeof e==`boolean`?(t.boundary=4,t.storage=4):e.isVector2?(t.boundary=8,t.storage=8):e.isVector3||e.isColor?(t.boundary=16,t.storage=12):e.isVector4?(t.boundary=16,t.storage=16):e.isMatrix3?(t.boundary=48,t.storage=48):e.isMatrix4?(t.boundary=64,t.storage=64):e.isTexture?U(`WebGLRenderer: Texture samplers can not be part of an uniforms group.`):ArrayBuffer.isView(e)?(t.boundary=16,t.storage=e.byteLength):U(`WebGLRenderer: Unsupported uniform value type.`,e),t}function v(t){let n=t.target;n.removeEventListener(`dispose`,v);let r=o.indexOf(n.__bindingPointIndex);o.splice(r,1),e.deleteBuffer(i[n.id]),delete i[n.id],delete a[n.id]}function y(){for(let t in i)e.deleteBuffer(i[t]);o=[],i={},a={}}return{bind:c,update:l,dispose:y}}var wl=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]),Tl=null;function El(){return Tl===null&&(Tl=new Oi(wl,16,16,Re,De),Tl.name=`DFG_LUT`,Tl.minFilter=L,Tl.magFilter=L,Tl.wrapS=_e,Tl.wrapT=_e,Tl.generateMipmaps=!1,Tl.needsUpdate=!0),Tl}var Dl=class{constructor(e={}){let{canvas:t=Vt(),context:n=null,depth:r=!0,stencil:i=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:s=!0,preserveDrawingBuffer:c=!1,powerPreference:l=`default`,failIfMajorPerformanceCaveat:u=!1,reversedDepthBuffer:d=!1,outputBufferType:f=Ce}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<`u`&&n instanceof WebGLRenderingContext)throw Error(`THREE.WebGLRenderer: WebGL 1 is not supported since r163.`);p=n.getContextAttributes().alpha}else p=a;let m=f,h=new Set([Be,ze,Le]),g=new Set([Ce,Ee,Te,Ae,Oe,ke]),_=new Uint32Array(4),v=new Int32Array(4),y=new q,b=null,x=null,S=[],C=[],w=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=0,this.toneMappingExposure=1,this.transmissionResolutionScale=1;let T=this,E=!1,D=null,O=null,k=null,A=null;this._outputColorSpace=jt;let ee=0,te=0,j=null,M=-1,ne=null,N=new xn,re=new xn,ie=null,ae=new X(0),oe=0,P=t.width,se=t.height,F=1,ce=null,le=null,ue=new xn(0,0,P,se),de=new xn(0,0,P,se),fe=!1,pe=new Ii,me=!1,he=!1,ge=new En,_e=new q,ve=new xn,I={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0},ye=!1;function be(){return j===null?F:1}let L=n;function xe(e,n){return t.getContext(e,n)}try{let e={alpha:!0,depth:r,stencil:i,antialias:o,premultipliedAlpha:s,preserveDrawingBuffer:c,powerPreference:l,failIfMajorPerformanceCaveat:u};if(`setAttribute`in t&&t.setAttribute(`data-engine`,`three.js r185`),t.addEventListener(`webglcontextlost`,$e,!1),t.addEventListener(`webglcontextrestored`,et,!1),t.addEventListener(`webglcontextcreationerror`,tt,!1),L===null){let t=`webgl2`;if(L=xe(t,e),L===null)throw xe(t)?Error(`THREE.WebGLRenderer: Error creating WebGL context with your selected attributes.`):Error(`THREE.WebGLRenderer: Error creating WebGL context.`)}}catch(e){throw W(`WebGLRenderer: `+e.message),e}let R,we,z,B,V,H,je,Me,Ne,Pe,Fe,Ie,Re,Ve,He,Ue,We,Ge,Ke,qe,Je,Ye,Xe;function Ze(){R=new Go(L),R.init(),Je=new hl(L,R),we=new xo(L,R,e,Je),z=new pl(L,R),we.reversedDepthBuffer&&d&&z.buffers.depth.setReversed(!0),O=L.createFramebuffer(),k=L.createFramebuffer(),A=L.createFramebuffer(),B=new Jo(L),V=new qc,H=new ml(L,R,z,V,we,Je,B),je=new Wo(T),Me=new po(L),Ye=new yo(L,Me),Ne=new Ko(L,Me,B,Ye),Pe=new Xo(L,Ne,Me,Ye,B),Ge=new Yo(L,we,H),He=new So(V),Fe=new Kc(T,je,R,we,Ye,He),Ie=new Sl(T,V),Re=new Zc,Ve=new il(R),We=new vo(T,je,z,Pe,p,s),Ue=new fl(T,Pe,we),Xe=new Cl(L,B,we,z),Ke=new bo(L,R,B),qe=new qo(L,R,B),B.programs=Fe.programs,T.capabilities=we,T.extensions=R,T.properties=V,T.renderLists=Re,T.shadowMap=Ue,T.state=z,T.info=B}Ze(),m!==1009&&(w=new Qo(m,t.width,t.height,o,r,i));let Qe=new yl(T,L);this.xr=Qe,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){let e=R.get(`WEBGL_lose_context`);e&&e.loseContext()},this.forceContextRestore=function(){let e=R.get(`WEBGL_lose_context`);e&&e.restoreContext()},this.getPixelRatio=function(){return F},this.setPixelRatio=function(e){e!==void 0&&(F=e,this.setSize(P,se,!1))},this.getSize=function(e){return e.set(P,se)},this.setSize=function(e,n,r=!0){if(Qe.isPresenting){U(`WebGLRenderer: Can't change size while VR device is presenting.`);return}P=e,se=n,t.width=Math.floor(e*F),t.height=Math.floor(n*F),r===!0&&(t.style.width=e+`px`,t.style.height=n+`px`),w!==null&&w.setSize(t.width,t.height),this.setViewport(0,0,e,n)},this.getDrawingBufferSize=function(e){return e.set(P*F,se*F).floor()},this.setDrawingBufferSize=function(e,n,r){P=e,se=n,F=r,t.width=Math.floor(e*r),t.height=Math.floor(n*r),this.setViewport(0,0,e,n)},this.setEffects=function(e){if(m===1009){W(`WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.`);return}if(e){for(let t=0;t<e.length;t++)if(e[t].isOutputPass===!0){U(`WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.`);break}}w.setEffects(e||[])},this.getCurrentViewport=function(e){return e.copy(N)},this.getViewport=function(e){return e.copy(ue)},this.setViewport=function(e,t,n,r){e.isVector4?ue.set(e.x,e.y,e.z,e.w):ue.set(e,t,n,r),z.viewport(N.copy(ue).multiplyScalar(F).round())},this.getScissor=function(e){return e.copy(de)},this.setScissor=function(e,t,n,r){e.isVector4?de.set(e.x,e.y,e.z,e.w):de.set(e,t,n,r),z.scissor(re.copy(de).multiplyScalar(F).round())},this.getScissorTest=function(){return fe},this.setScissorTest=function(e){z.setScissorTest(fe=e)},this.setOpaqueSort=function(e){ce=e},this.setTransparentSort=function(e){le=e},this.getClearColor=function(e){return e.copy(We.getClearColor())},this.setClearColor=function(){We.setClearColor(...arguments)},this.getClearAlpha=function(){return We.getClearAlpha()},this.setClearAlpha=function(){We.setClearAlpha(...arguments)},this.clear=function(e=!0,t=!0,n=!0){let r=0;if(e){let e=!1;if(j!==null){let t=j.texture.format;e=h.has(t)}if(e){let e=j.texture.type,t=g.has(e),n=We.getClearColor(),r=We.getClearAlpha(),i=n.r,a=n.g,o=n.b;t?(_[0]=i,_[1]=a,_[2]=o,_[3]=r,L.clearBufferuiv(L.COLOR,0,_)):(v[0]=i,v[1]=a,v[2]=o,v[3]=r,L.clearBufferiv(L.COLOR,0,v))}else r|=L.COLOR_BUFFER_BIT}t&&(r|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),n&&(r|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),r!==0&&L.clear(r)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(e){e.setRenderer(this),D=e},this.dispose=function(){t.removeEventListener(`webglcontextlost`,$e,!1),t.removeEventListener(`webglcontextrestored`,et,!1),t.removeEventListener(`webglcontextcreationerror`,tt,!1),We.dispose(),Re.dispose(),Ve.dispose(),V.dispose(),je.dispose(),Pe.dispose(),Ye.dispose(),Xe.dispose(),Fe.dispose(),Qe.dispose(),Qe.removeEventListener(`sessionstart`,ct),Qe.removeEventListener(`sessionend`,lt),ut.stop()};function $e(e){e.preventDefault(),Ut(`WebGLRenderer: Context Lost.`),E=!0}function et(){Ut(`WebGLRenderer: Context Restored.`),E=!1;let e=B.autoReset,t=Ue.enabled,n=Ue.autoUpdate,r=Ue.needsUpdate,i=Ue.type;Ze(),B.autoReset=e,Ue.enabled=t,Ue.autoUpdate=n,Ue.needsUpdate=r,Ue.type=i}function tt(e){W(`WebGLRenderer: A WebGL context could not be created. Reason: `,e.statusMessage)}function nt(e){let t=e.target;t.removeEventListener(`dispose`,nt),rt(t)}function rt(e){it(e),V.remove(e)}function it(e){let t=V.get(e).programs;t!==void 0&&(t.forEach(function(e){Fe.releaseProgram(e)}),e.isShaderMaterial&&Fe.releaseShaderCache(e))}this.renderBufferDirect=function(e,t,n,r,i,a){t===null&&(t=I);let o=i.isMesh&&i.matrixWorld.determinantAffine()<0,s=bt(e,t,n,r,i);z.setMaterial(r,o);let c=n.index,l=1;if(r.wireframe===!0){if(c=Ne.getWireframeAttribute(n),c===void 0)return;l=2}let u=n.drawRange,d=n.attributes.position,f=u.start*l,p=(u.start+u.count)*l;a!==null&&(f=Math.max(f,a.start*l),p=Math.min(p,(a.start+a.count)*l)),c===null?d!=null&&(f=Math.max(f,0),p=Math.min(p,d.count)):(f=Math.max(f,0),p=Math.min(p,c.count));let m=p-f;if(m<0||m===1/0)return;Ye.setup(i,r,s,n,c);let h,g=Ke;if(c!==null&&(h=Me.get(c),g=qe,g.setIndex(h)),i.isMesh)r.wireframe===!0?(z.setLineWidth(r.wireframeLinewidth*be()),g.setMode(L.LINES)):g.setMode(L.TRIANGLES);else if(i.isLine){let e=r.linewidth;e===void 0&&(e=1),z.setLineWidth(e*be()),i.isLineSegments?g.setMode(L.LINES):i.isLineLoop?g.setMode(L.LINE_LOOP):g.setMode(L.LINE_STRIP)}else i.isPoints?g.setMode(L.POINTS):i.isSprite&&g.setMode(L.TRIANGLES);if(i.isBatchedMesh){if(R.get(`WEBGL_multi_draw`))g.renderMultiDraw(i._multiDrawStarts,i._multiDrawCounts,i._multiDrawCount);else{let e=i._multiDrawStarts,t=i._multiDrawCounts,n=i._multiDrawCount,a=c?Me.get(c).bytesPerElement:1,o=V.get(r).currentProgram.getUniforms();for(let r=0;r<n;r++)o.setValue(L,`_gl_DrawID`,r),g.render(e[r]/a,t[r])}}else if(i.isInstancedMesh)g.renderInstances(f,m,i.count);else if(n.isInstancedBufferGeometry){let e=n._maxInstanceCount===void 0?1/0:n._maxInstanceCount,t=Math.min(n.instanceCount,e);g.renderInstances(f,m,t)}else g.render(f,m)};function at(e,t,n){e.transparent===!0&&e.side===2&&e.forceSinglePass===!1?(e.side=1,e.needsUpdate=!0,gt(e,t,n),e.side=0,e.needsUpdate=!0,gt(e,t,n),e.side=2):gt(e,t,n)}this.compile=function(e,t,n=null){n===null&&(n=e),x=Ve.get(n),x.init(t),C.push(x),n.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(x.pushLight(e),e.castShadow&&x.pushShadow(e))}),e!==n&&e.traverseVisible(function(e){e.isLight&&e.layers.test(t.layers)&&(x.pushLight(e),e.castShadow&&x.pushShadow(e))}),x.setupLights();let r=new Set;return e.traverse(function(e){if(!(e.isMesh||e.isPoints||e.isLine||e.isSprite))return;let t=e.material;if(t){if(Array.isArray(t))for(let i=0;i<t.length;i++){let a=t[i];at(a,n,e),r.add(a)}else at(t,n,e),r.add(t)}}),x=C.pop(),r},this.compileAsync=function(e,t,n=null){let r=this.compile(e,t,n);return new Promise(t=>{function n(){if(r.forEach(function(e){V.get(e).currentProgram.isReady()&&r.delete(e)}),r.size===0){t(e);return}setTimeout(n,10)}R.get(`KHR_parallel_shader_compile`)===null?setTimeout(n,10):n()})};let ot=null;function st(e){ot&&ot(e)}function ct(){ut.stop()}function lt(){ut.start()}let ut=new fo;ut.setAnimationLoop(st),typeof self<`u`&&ut.setContext(self),this.setAnimationLoop=function(e){ot=e,Qe.setAnimationLoop(e),e===null?ut.stop():ut.start()},Qe.addEventListener(`sessionstart`,ct),Qe.addEventListener(`sessionend`,lt),this.render=function(e,t){if(t!==void 0&&t.isCamera!==!0){W(`WebGLRenderer.render: camera is not an instance of THREE.Camera.`);return}if(E===!0)return;D!==null&&D.renderStart(e,t);let n=Qe.enabled===!0&&Qe.isPresenting===!0,r=w!==null&&(j===null||n)&&w.begin(T,j);if(e.matrixWorldAutoUpdate===!0&&e.updateMatrixWorld(),t.parent===null&&t.matrixWorldAutoUpdate===!0&&t.updateMatrixWorld(),Qe.enabled===!0&&Qe.isPresenting===!0&&(w===null||w.isCompositing()===!1)&&(Qe.cameraAutoUpdate===!0&&Qe.updateCamera(t),t=Qe.getCamera()),e.isScene===!0&&e.onBeforeRender(T,e,t,j),x=Ve.get(e,C.length),x.init(t),x.state.textureUnits=H.getTextureUnits(),C.push(x),ge.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),pe.setFromProjectionMatrix(ge,Lt,t.reversedDepth),he=this.localClippingEnabled,me=He.init(this.clippingPlanes,he),b=Re.get(e,S.length),b.init(),S.push(b),Qe.enabled===!0&&Qe.isPresenting===!0){let e=T.xr.getDepthSensingMesh();e!==null&&dt(e,t,-1/0,T.sortObjects)}dt(e,t,0,T.sortObjects),b.finish(),T.sortObjects===!0&&b.sort(ce,le,t.reversedDepth),ye=Qe.enabled===!1||Qe.isPresenting===!1||Qe.hasDepthSensing()===!1,ye&&We.addToRenderList(b,e),this.info.render.frame++,this.info.autoReset===!0&&this.info.reset(),me===!0&&He.beginShadows();let i=x.state.shadowsArray;if(Ue.render(i,e,t),me===!0&&He.endShadows(),(r&&w.hasRenderPass())===!1){let n=b.opaque,r=b.transmissive;if(x.setupLights(),t.isArrayCamera){let i=t.cameras;if(r.length>0)for(let t=0,a=i.length;t<a;t++){let a=i[t];pt(n,r,e,a)}ye&&We.render(e);for(let t=0,n=i.length;t<n;t++){let n=i[t];ft(b,e,n,n.viewport)}}else r.length>0&&pt(n,r,e,t),ye&&We.render(e),ft(b,e,t)}j!==null&&te===0&&(H.updateMultisampleRenderTarget(j),H.updateRenderTargetMipmap(j)),r&&w.end(T),e.isScene===!0&&e.onAfterRender(T,e,t),Ye.resetDefaultState(),M=-1,ne=null,C.pop(),C.length>0?(x=C[C.length-1],H.setTextureUnits(x.state.textureUnits),me===!0&&He.setGlobalState(T.clippingPlanes,x.state.camera)):x=null,S.pop(),b=S.length>0?S[S.length-1]:null,D!==null&&D.renderEnd()};function dt(e,t,n,r){if(e.visible===!1)return;if(e.layers.test(t.layers)){if(e.isGroup)n=e.renderOrder;else if(e.isLOD)e.autoUpdate===!0&&e.update(t);else if(e.isLightProbeGrid)x.pushLightProbeGrid(e);else if(e.isLight)x.pushLight(e),e.castShadow&&x.pushShadow(e);else if(e.isSprite){if(!e.frustumCulled||pe.intersectsSprite(e)){r&&ve.setFromMatrixPosition(e.matrixWorld).applyMatrix4(ge);let t=Pe.update(e),i=e.material;i.visible&&b.push(e,t,i,n,ve.z,null)}}else if((e.isMesh||e.isLine||e.isPoints)&&(!e.frustumCulled||pe.intersectsObject(e))){let t=Pe.update(e),i=e.material;if(r&&(e.boundingSphere===void 0?(t.boundingSphere===null&&t.computeBoundingSphere(),ve.copy(t.boundingSphere.center)):(e.boundingSphere===null&&e.computeBoundingSphere(),ve.copy(e.boundingSphere.center)),ve.applyMatrix4(e.matrixWorld).applyMatrix4(ge)),Array.isArray(i)){let r=t.groups;for(let a=0,o=r.length;a<o;a++){let o=r[a],s=i[o.materialIndex];s&&s.visible&&b.push(e,t,s,n,ve.z,o)}}else i.visible&&b.push(e,t,i,n,ve.z,null)}}let i=e.children;for(let e=0,a=i.length;e<a;e++)dt(i[e],t,n,r)}function ft(e,t,n,r){let{opaque:i,transmissive:a,transparent:o}=e;x.setupLightsView(n),me===!0&&He.setGlobalState(T.clippingPlanes,n),r&&z.viewport(N.copy(r)),i.length>0&&mt(i,t,n),a.length>0&&mt(a,t,n),o.length>0&&mt(o,t,n),z.buffers.depth.setTest(!0),z.buffers.depth.setMask(!0),z.buffers.color.setMask(!0),z.setPolygonOffset(!1)}function pt(e,t,n,r){if((n.isScene===!0?n.overrideMaterial:null)!==null)return;if(x.state.transmissionRenderTarget[r.id]===void 0){let e=R.has(`EXT_color_buffer_half_float`)||R.has(`EXT_color_buffer_float`);x.state.transmissionRenderTarget[r.id]=new Cn(1,1,{generateMipmaps:!0,type:e?De:Ce,minFilter:Se,samples:Math.max(4,we.samples),stencilBuffer:i,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Y.workingColorSpace})}let a=x.state.transmissionRenderTarget[r.id],o=r.viewport||N;a.setSize(o.z*T.transmissionResolutionScale,o.w*T.transmissionResolutionScale);let s=T.getRenderTarget(),c=T.getActiveCubeFace(),l=T.getActiveMipmapLevel();T.setRenderTarget(a),T.getClearColor(ae),oe=T.getClearAlpha(),oe<1&&T.setClearColor(16777215,.5),T.clear(),ye&&We.render(n);let u=T.toneMapping;T.toneMapping=0;let d=r.viewport;if(r.viewport!==void 0&&(r.viewport=void 0),x.setupLightsView(r),me===!0&&He.setGlobalState(T.clippingPlanes,r),mt(e,n,r),H.updateMultisampleRenderTarget(a),H.updateRenderTargetMipmap(a),R.has(`WEBGL_multisampled_render_to_texture`)===!1){let e=!1;for(let i=0,a=t.length;i<a;i++){let{object:a,geometry:o,material:s,group:c}=t[i];if(s.side===2&&a.layers.test(r.layers)){let t=s.side;s.side=1,s.needsUpdate=!0,ht(a,n,r,o,s,c),s.side=t,s.needsUpdate=!0,e=!0}}e===!0&&(H.updateMultisampleRenderTarget(a),H.updateRenderTargetMipmap(a))}T.setRenderTarget(s,c,l),T.setClearColor(ae,oe),d!==void 0&&(r.viewport=d),T.toneMapping=u}function mt(e,t,n){let r=t.isScene===!0?t.overrideMaterial:null;for(let i=0,a=e.length;i<a;i++){let a=e[i],{object:o,geometry:s,group:c}=a,l=a.material;l.allowOverride===!0&&r!==null&&(l=r),o.layers.test(n.layers)&&ht(o,t,n,s,l,c)}}function ht(e,t,n,r,i,a){e.onBeforeRender(T,t,n,r,i,a),e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse,e.matrixWorld),e.normalMatrix.getNormalMatrix(e.modelViewMatrix),i.onBeforeRender(T,t,n,r,e,a),i.transparent===!0&&i.side===2&&i.forceSinglePass===!1?(i.side=1,i.needsUpdate=!0,T.renderBufferDirect(n,t,r,i,e,a),i.side=0,i.needsUpdate=!0,T.renderBufferDirect(n,t,r,i,e,a),i.side=2):T.renderBufferDirect(n,t,r,i,e,a),e.onAfterRender(T,t,n,r,i,a)}function gt(e,t,n){t.isScene!==!0&&(t=I);let r=V.get(e),i=x.state.lights,a=x.state.shadowsArray,o=i.state.version,s=Fe.getParameters(e,i.state,a,t,n,x.state.lightProbeGridArray),c=Fe.getProgramCacheKey(s),l=r.programs;r.environment=e.isMeshStandardMaterial||e.isMeshLambertMaterial||e.isMeshPhongMaterial?t.environment:null,r.fog=t.fog;let u=e.isMeshStandardMaterial||e.isMeshLambertMaterial&&!e.envMap||e.isMeshPhongMaterial&&!e.envMap;r.envMap=je.get(e.envMap||r.environment,u),r.envMapRotation=r.environment!==null&&e.envMap===null?t.environmentRotation:e.envMapRotation,l===void 0&&(e.addEventListener(`dispose`,nt),l=new Map,r.programs=l);let d=l.get(c);if(d!==void 0){if(r.currentProgram===d&&r.lightsStateVersion===o)return vt(e,s),d}else s.uniforms=Fe.getUniforms(e),D!==null&&e.isNodeMaterial&&D.build(e,n,s),e.onBeforeCompile(s,T),d=Fe.acquireProgram(s,c),l.set(c,d),r.uniforms=s.uniforms;let f=r.uniforms;return(!e.isShaderMaterial&&!e.isRawShaderMaterial||e.clipping===!0)&&(f.clippingPlanes=He.uniform),vt(e,s),r.needsLights=St(e),r.lightsStateVersion=o,r.needsLights&&(f.ambientLightColor.value=i.state.ambient,f.lightProbe.value=i.state.probe,f.directionalLights.value=i.state.directional,f.directionalLightShadows.value=i.state.directionalShadow,f.spotLights.value=i.state.spot,f.spotLightShadows.value=i.state.spotShadow,f.rectAreaLights.value=i.state.rectArea,f.ltc_1.value=i.state.rectAreaLTC1,f.ltc_2.value=i.state.rectAreaLTC2,f.pointLights.value=i.state.point,f.pointLightShadows.value=i.state.pointShadow,f.hemisphereLights.value=i.state.hemi,f.directionalShadowMatrix.value=i.state.directionalShadowMatrix,f.spotLightMatrix.value=i.state.spotLightMatrix,f.spotLightMap.value=i.state.spotLightMap,f.pointShadowMatrix.value=i.state.pointShadowMatrix),r.lightProbeGrid=x.state.lightProbeGridArray.length>0,r.currentProgram=d,r.uniformsList=null,d}function _t(e){if(e.uniformsList===null){let t=e.currentProgram.getUniforms();e.uniformsList=ac.seqWithValue(t.seq,e.uniforms)}return e.uniformsList}function vt(e,t){let n=V.get(e);n.outputColorSpace=t.outputColorSpace,n.batching=t.batching,n.batchingColor=t.batchingColor,n.instancing=t.instancing,n.instancingColor=t.instancingColor,n.instancingMorph=t.instancingMorph,n.skinning=t.skinning,n.morphTargets=t.morphTargets,n.morphNormals=t.morphNormals,n.morphColors=t.morphColors,n.morphTargetsCount=t.morphTargetsCount,n.numClippingPlanes=t.numClippingPlanes,n.numIntersection=t.numClipIntersection,n.vertexAlphas=t.vertexAlphas,n.vertexTangents=t.vertexTangents,n.toneMapping=t.toneMapping}function yt(e,t){if(e.length===0)return null;if(e.length===1)return e[0].texture===null?null:e[0];y.setFromMatrixPosition(t.matrixWorld);for(let t=0,n=e.length;t<n;t++){let n=e[t];if(n.texture!==null&&n.boundingBox.containsPoint(y))return n}return null}function bt(e,t,n,r,i){t.isScene!==!0&&(t=I),H.resetTextureUnits();let a=t.fog,o=r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial?t.environment:null,s=j===null?T.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:Y.workingColorSpace,c=r.isMeshStandardMaterial||r.isMeshLambertMaterial&&!r.envMap||r.isMeshPhongMaterial&&!r.envMap,l=je.get(r.envMap||o,c),u=r.vertexColors===!0&&!!n.attributes.color&&n.attributes.color.itemSize===4,d=!!n.attributes.tangent&&(!!r.normalMap||r.anisotropy>0),f=!!n.morphAttributes.position,p=!!n.morphAttributes.normal,m=!!n.morphAttributes.color,h=0;r.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(h=T.toneMapping);let g=n.morphAttributes.position||n.morphAttributes.normal||n.morphAttributes.color,_=g===void 0?0:g.length,v=V.get(r),y=x.state.lights;if(me===!0&&(he===!0||e!==ne)){let t=e===ne&&r.id===M;He.setState(r,e,t)}let b=!1;r.version===v.__version?v.needsLights&&v.lightsStateVersion!==y.state.version?b=!0:v.outputColorSpace===s?i.isBatchedMesh&&v.batching===!1||!i.isBatchedMesh&&v.batching===!0||i.isBatchedMesh&&v.batchingColor===!0&&i.colorTexture===null||i.isBatchedMesh&&v.batchingColor===!1&&i.colorTexture!==null||i.isInstancedMesh&&v.instancing===!1||!i.isInstancedMesh&&v.instancing===!0||i.isSkinnedMesh&&v.skinning===!1||!i.isSkinnedMesh&&v.skinning===!0||i.isInstancedMesh&&v.instancingColor===!0&&i.instanceColor===null||i.isInstancedMesh&&v.instancingColor===!1&&i.instanceColor!==null||i.isInstancedMesh&&v.instancingMorph===!0&&i.morphTexture===null||i.isInstancedMesh&&v.instancingMorph===!1&&i.morphTexture!==null?b=!0:v.envMap===l?r.fog===!0&&v.fog!==a||v.numClippingPlanes!==void 0&&(v.numClippingPlanes!==He.numPlanes||v.numIntersection!==He.numIntersection)?b=!0:v.vertexAlphas===u&&v.vertexTangents===d&&v.morphTargets===f&&v.morphNormals===p&&v.morphColors===m&&v.toneMapping===h&&v.morphTargetsCount===_?!!v.lightProbeGrid!=x.state.lightProbeGridArray.length>0&&(b=!0):b=!0:b=!0:b=!0:(b=!0,v.__version=r.version);let S=v.currentProgram;b===!0&&(S=gt(r,t,i),D&&r.isNodeMaterial&&D.onUpdateProgram(r,S,v));let C=!1,w=!1,E=!1,O=S.getUniforms(),k=v.uniforms;if(z.useProgram(S.program)&&(C=!0,w=!0,E=!0),r.id!==M&&(M=r.id,w=!0),v.needsLights){let e=yt(x.state.lightProbeGridArray,i);v.lightProbeGrid!==e&&(v.lightProbeGrid=e,w=!0)}if(C||ne!==e){z.buffers.depth.getReversed()&&e.reversedDepth!==!0&&(e._reversedDepth=!0,e.updateProjectionMatrix()),O.setValue(L,`projectionMatrix`,e.projectionMatrix),O.setValue(L,`viewMatrix`,e.matrixWorldInverse);let t=O.map.cameraPosition;t!==void 0&&t.setValue(L,_e.setFromMatrixPosition(e.matrixWorld)),we.logarithmicDepthBuffer&&O.setValue(L,`logDepthBufFC`,2/(Math.log(e.far+1)/Math.LN2)),(r.isMeshPhongMaterial||r.isMeshToonMaterial||r.isMeshLambertMaterial||r.isMeshBasicMaterial||r.isMeshStandardMaterial||r.isShaderMaterial)&&O.setValue(L,`isOrthographic`,e.isOrthographicCamera===!0),ne!==e&&(ne=e,w=!0,E=!0)}if(v.needsLights&&(y.state.directionalShadowMap.length>0&&O.setValue(L,`directionalShadowMap`,y.state.directionalShadowMap,H),y.state.spotShadowMap.length>0&&O.setValue(L,`spotShadowMap`,y.state.spotShadowMap,H),y.state.pointShadowMap.length>0&&O.setValue(L,`pointShadowMap`,y.state.pointShadowMap,H)),i.isSkinnedMesh){O.setOptional(L,i,`bindMatrix`),O.setOptional(L,i,`bindMatrixInverse`);let e=i.skeleton;e&&(e.boneTexture===null&&e.computeBoneTexture(),O.setValue(L,`boneTexture`,e.boneTexture,H))}i.isBatchedMesh&&(O.setOptional(L,i,`batchingTexture`),O.setValue(L,`batchingTexture`,i._matricesTexture,H),O.setOptional(L,i,`batchingIdTexture`),O.setValue(L,`batchingIdTexture`,i._indirectTexture,H),O.setOptional(L,i,`batchingColorTexture`),i._colorsTexture!==null&&O.setValue(L,`batchingColorTexture`,i._colorsTexture,H));let A=n.morphAttributes;if((A.position!==void 0||A.normal!==void 0||A.color!==void 0)&&Ge.update(i,n,S),(w||v.receiveShadow!==i.receiveShadow)&&(v.receiveShadow=i.receiveShadow,O.setValue(L,`receiveShadow`,i.receiveShadow)),(r.isMeshStandardMaterial||r.isMeshLambertMaterial||r.isMeshPhongMaterial)&&r.envMap===null&&t.environment!==null&&(k.envMapIntensity.value=t.environmentIntensity),k.dfgLUT!==void 0&&(k.dfgLUT.value=El()),w){if(O.setValue(L,`toneMappingExposure`,T.toneMappingExposure),v.needsLights&&xt(k,E),a&&r.fog===!0&&Ie.refreshFogUniforms(k,a),Ie.refreshMaterialUniforms(k,r,F,se,x.state.transmissionRenderTarget[e.id]),v.needsLights&&v.lightProbeGrid){let e=v.lightProbeGrid;k.probesSH.value=e.texture,k.probesMin.value.copy(e.boundingBox.min),k.probesMax.value.copy(e.boundingBox.max),k.probesResolution.value.copy(e.resolution)}ac.upload(L,_t(v),k,H)}if(r.isShaderMaterial&&r.uniformsNeedUpdate===!0&&(ac.upload(L,_t(v),k,H),r.uniformsNeedUpdate=!1),r.isSpriteMaterial&&O.setValue(L,`center`,i.center),O.setValue(L,`modelViewMatrix`,i.modelViewMatrix),O.setValue(L,`normalMatrix`,i.normalMatrix),O.setValue(L,`modelMatrix`,i.matrixWorld),r.uniformsGroups!==void 0){let e=r.uniformsGroups;for(let t=0,n=e.length;t<n;t++){let n=e[t];Xe.update(n,S),Xe.bind(n,S)}}return S}function xt(e,t){e.ambientLightColor.needsUpdate=t,e.lightProbe.needsUpdate=t,e.directionalLights.needsUpdate=t,e.directionalLightShadows.needsUpdate=t,e.pointLights.needsUpdate=t,e.pointLightShadows.needsUpdate=t,e.spotLights.needsUpdate=t,e.spotLightShadows.needsUpdate=t,e.rectAreaLights.needsUpdate=t,e.hemisphereLights.needsUpdate=t}function St(e){return e.isMeshLambertMaterial||e.isMeshToonMaterial||e.isMeshPhongMaterial||e.isMeshStandardMaterial||e.isShadowMaterial||e.isShaderMaterial&&e.lights===!0}this.getActiveCubeFace=function(){return ee},this.getActiveMipmapLevel=function(){return te},this.getRenderTarget=function(){return j},this.setRenderTargetTextures=function(e,t,n){let r=V.get(e);r.__autoAllocateDepthBuffer=e.resolveDepthBuffer===!1,r.__autoAllocateDepthBuffer===!1&&(r.__useRenderToTexture=!1),V.get(e.texture).__webglTexture=t,V.get(e.depthTexture).__webglTexture=r.__autoAllocateDepthBuffer?void 0:n,r.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(e,t){let n=V.get(e);n.__webglFramebuffer=t,n.__useDefaultFramebuffer=t===void 0},this.setRenderTarget=function(e,t=0,n=0){j=e,ee=t,te=n;let r=null,i=!1,a=!1;if(e){let o=V.get(e);if(o.__useDefaultFramebuffer!==void 0){z.bindFramebuffer(L.FRAMEBUFFER,o.__webglFramebuffer),N.copy(e.viewport),re.copy(e.scissor),ie=e.scissorTest,z.viewport(N),z.scissor(re),z.setScissorTest(ie),M=-1;return}if(o.__webglFramebuffer===void 0)H.setupRenderTarget(e);else if(o.__hasExternalTextures)H.rebindTextures(e,V.get(e.texture).__webglTexture,V.get(e.depthTexture).__webglTexture);else if(e.depthBuffer){let t=e.depthTexture;if(o.__boundDepthTexture!==t){if(t!==null&&V.has(t)&&(e.width!==t.image.width||e.height!==t.image.height))throw Error(`THREE.WebGLRenderer: Attached DepthTexture is initialized to the incorrect size.`);H.setupDepthRenderbuffer(e)}}let s=e.texture;(s.isData3DTexture||s.isDataArrayTexture||s.isCompressedArrayTexture)&&(a=!0);let c=V.get(e).__webglFramebuffer;e.isWebGLCubeRenderTarget?(r=Array.isArray(c[t])?c[t][n]:c[t],i=!0):r=e.samples>0&&H.useMultisampledRTT(e)===!1?V.get(e).__webglMultisampledFramebuffer:Array.isArray(c)?c[n]:c,N.copy(e.viewport),re.copy(e.scissor),ie=e.scissorTest}else N.copy(ue).multiplyScalar(F).floor(),re.copy(de).multiplyScalar(F).floor(),ie=fe;if(n!==0&&(r=O),z.bindFramebuffer(L.FRAMEBUFFER,r)&&z.drawBuffers(e,r),z.viewport(N),z.scissor(re),z.setScissorTest(ie),i){let r=V.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+t,r.__webglTexture,n)}else if(a){let r=t;for(let t=0;t<e.textures.length;t++){let i=V.get(e.textures[t]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+t,i.__webglTexture,n,r)}}else if(e!==null&&n!==0){let t=V.get(e.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,t.__webglTexture,n)}M=-1},this.readRenderTargetPixels=function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget)){W(`WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);return}let c=V.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){z.bindFramebuffer(L.FRAMEBUFFER,c);try{let o=e.textures[s],c=o.format,l=o.type;if(e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s),!we.textureFormatReadable(c)){W(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.`);return}if(!we.textureTypeReadable(l)){W(`WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.`);return}t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i&&L.readPixels(t,n,r,i,Je.convert(c),Je.convert(l),a)}finally{let e=j===null?null:V.get(j).__webglFramebuffer;z.bindFramebuffer(L.FRAMEBUFFER,e)}}},this.readRenderTargetPixelsAsync=async function(e,t,n,r,i,a,o,s=0){if(!(e&&e.isWebGLRenderTarget))throw Error(`THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.`);let c=V.get(e).__webglFramebuffer;if(e.isWebGLCubeRenderTarget&&o!==void 0&&(c=c[o]),c){if(t>=0&&t<=e.width-r&&n>=0&&n<=e.height-i){z.bindFramebuffer(L.FRAMEBUFFER,c);let o=e.textures[s],l=o.format,u=o.type;if(e.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+s),!we.textureFormatReadable(l))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.`);if(!we.textureTypeReadable(u))throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.`);let d=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,d),L.bufferData(L.PIXEL_PACK_BUFFER,a.byteLength,L.STREAM_READ),L.readPixels(t,n,r,i,Je.convert(l),Je.convert(u),0);let f=j===null?null:V.get(j).__webglFramebuffer;z.bindFramebuffer(L.FRAMEBUFFER,f);let p=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await Kt(L,p,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,d),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,a),L.deleteBuffer(d),L.deleteSync(p),a}throw Error(`THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.`)}},this.copyFramebufferToTexture=function(e,t=null,n=0){let r=2**-n,i=Math.floor(e.image.width*r),a=Math.floor(e.image.height*r),o=t===null?0:t.x,s=t===null?0:t.y;H.setTexture2D(e,0),L.copyTexSubImage2D(L.TEXTURE_2D,n,0,0,o,s,i,a),z.unbindTexture()},this.copyTextureToTexture=function(e,t,n=null,r=null,i=0,a=0){let o,s,c,l,u,d,f,p,m,h=e.isCompressedTexture?e.mipmaps[a]:e.image;if(n!==null)o=n.max.x-n.min.x,s=n.max.y-n.min.y,c=n.isBox3?n.max.z-n.min.z:1,l=n.min.x,u=n.min.y,d=n.isBox3?n.min.z:0;else{let t=2**-i;o=Math.floor(h.width*t),s=Math.floor(h.height*t),c=e.isDataArrayTexture?h.depth:e.isData3DTexture?Math.floor(h.depth*t):1,l=0,u=0,d=0}r===null?(f=0,p=0,m=0):(f=r.x,p=r.y,m=r.z);let g=Je.convert(t.format),_=Je.convert(t.type),v;t.isData3DTexture?(H.setTexture3D(t,0),v=L.TEXTURE_3D):t.isDataArrayTexture||t.isCompressedArrayTexture?(H.setTexture2DArray(t,0),v=L.TEXTURE_2D_ARRAY):(H.setTexture2D(t,0),v=L.TEXTURE_2D),z.activeTexture(L.TEXTURE0),z.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,t.flipY),z.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,t.premultiplyAlpha),z.pixelStorei(L.UNPACK_ALIGNMENT,t.unpackAlignment);let y=z.getParameter(L.UNPACK_ROW_LENGTH),b=z.getParameter(L.UNPACK_IMAGE_HEIGHT),x=z.getParameter(L.UNPACK_SKIP_PIXELS),S=z.getParameter(L.UNPACK_SKIP_ROWS),C=z.getParameter(L.UNPACK_SKIP_IMAGES);z.pixelStorei(L.UNPACK_ROW_LENGTH,h.width),z.pixelStorei(L.UNPACK_IMAGE_HEIGHT,h.height),z.pixelStorei(L.UNPACK_SKIP_PIXELS,l),z.pixelStorei(L.UNPACK_SKIP_ROWS,u),z.pixelStorei(L.UNPACK_SKIP_IMAGES,d);let w=e.isDataArrayTexture||e.isData3DTexture,T=t.isDataArrayTexture||t.isData3DTexture;if(e.isDepthTexture){let n=V.get(e),r=V.get(t),h=V.get(n.__renderTarget),g=V.get(r.__renderTarget);z.bindFramebuffer(L.READ_FRAMEBUFFER,h.__webglFramebuffer),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,g.__webglFramebuffer);for(let n=0;n<c;n++)w&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,V.get(e).__webglTexture,i,d+n),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,V.get(t).__webglTexture,a,m+n)),L.blitFramebuffer(l,u,o,s,f,p,o,s,L.DEPTH_BUFFER_BIT,L.NEAREST);z.bindFramebuffer(L.READ_FRAMEBUFFER,null),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(i!==0||e.isRenderTargetTexture||V.has(e)){let n=V.get(e),r=V.get(t);z.bindFramebuffer(L.READ_FRAMEBUFFER,k),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,A);for(let e=0;e<c;e++)w?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,n.__webglTexture,i,d+e):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,n.__webglTexture,i),T?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,r.__webglTexture,a,m+e):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,r.__webglTexture,a),i===0?T?L.copyTexSubImage3D(v,a,f,p,m+e,l,u,o,s):L.copyTexSubImage2D(v,a,f,p,l,u,o,s):L.blitFramebuffer(l,u,o,s,f,p,o,s,L.COLOR_BUFFER_BIT,L.NEAREST);z.bindFramebuffer(L.READ_FRAMEBUFFER,null),z.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else T?e.isDataTexture||e.isData3DTexture?L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h.data):t.isCompressedArrayTexture?L.compressedTexSubImage3D(v,a,f,p,m,o,s,c,g,h.data):L.texSubImage3D(v,a,f,p,m,o,s,c,g,_,h):e.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h.data):e.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,a,f,p,h.width,h.height,g,h.data):L.texSubImage2D(L.TEXTURE_2D,a,f,p,o,s,g,_,h);z.pixelStorei(L.UNPACK_ROW_LENGTH,y),z.pixelStorei(L.UNPACK_IMAGE_HEIGHT,b),z.pixelStorei(L.UNPACK_SKIP_PIXELS,x),z.pixelStorei(L.UNPACK_SKIP_ROWS,S),z.pixelStorei(L.UNPACK_SKIP_IMAGES,C),a===0&&t.generateMipmaps&&L.generateMipmap(v),z.unbindTexture()},this.initRenderTarget=function(e){V.get(e).__webglFramebuffer===void 0&&H.setupRenderTarget(e)},this.initTexture=function(e){e.isCubeTexture?H.setTextureCube(e,0):e.isData3DTexture?H.setTexture3D(e,0):e.isDataArrayTexture||e.isCompressedArrayTexture?H.setTexture2DArray(e,0):H.setTexture2D(e,0),z.unbindTexture()},this.resetState=function(){ee=0,te=0,j=null,z.reset(),Ye.reset()},typeof __THREE_DEVTOOLS__<`u`&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent(`observe`,{detail:this}))}get coordinateSystem(){return Lt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;let t=this.getContext();t.drawingBufferColorSpace=Y._getDrawingBufferColorSpace(e),t.unpackColorSpace=Y._getUnpackColorSpace()}};function Ol(e=480,t=270){let n=new Uint8Array(e*t*4);for(let r=0;r<t;r+=1){let i=t===1?0:r/(t-1),a=Math.round(18+-13*i),o=Math.round(28+-20*i),s=Math.round(52+-38*i);for(let t=0;t<e;t+=1){let i=(r*e+t)*4;n[i]=a,n[i+1]=o,n[i+2]=s,n[i+3]=255}}let r=1592639710,i=()=>(r=Math.imul(r,1664525)+1013904223>>>0,r/4294967296);for(let r=0;r<140;r+=1){let r=Math.floor(i()*e),a=Math.floor(i()*t),o=150+Math.floor(i()*105);kl(n,e,t,r,a,o,20),i()<.12&&r+1<e&&kl(n,e,t,r+1,a,o,20)}let a=new Oi(n,e,t);return a.magFilter=I,a.minFilter=I,a.generateMipmaps=!1,a.colorSpace=jt,a.needsUpdate=!0,a}function kl(e,t,n,r,i,a,o){if(r<0||i<0||r>=t||i>=n)return;let s=(i*t+r)*4;e[s]=a,e[s+1]=a,e[s+2]=Math.min(255,a+o),e[s+3]=255}var Al={star:`#FFD166`,planet:`#5B8CDE`,asteroid:`#A8A29E`};function jl(e){return e.visualColor===void 0?Al[e.category]:e.visualColor}function Ml(e){return{id:e.id,position:E(e.position),radius:D(e.visualRadius),color:jl(e)}}function Nl(e,t){let n=[],r=[],i=new Set;for(let a of e.bodies){i.add(a.id);let e=Ml(a);t.has(a.id)?r.push(e):n.push(e)}let a=[];for(let e of t)i.has(e)||a.push(e);return{create:n,update:r,remove:a}}var Pl=10479871,Fl=.43633,Il=.35,Ll=2236962,Rl=8939042,zl=.25,Bl=.85,Vl=class{renderer;scene=new cr;camera;renderTarget;quadScene=new cr;quadCamera=new Ua(-1,1,1,-1,0,1);sphereGeometry=new na(1,16,12);meshes=new Map;selectedId=null;toolGhost=null;toolGhostMaterial=null;toolArrow=null;toolArrowGeometry=null;toolArrowMaterial=null;backgroundTexture;quadMaterial;clearColor=new X(197898);viewport={x:0,y:0,width:480,height:270};constructor(e){this.renderer=new Dl({canvas:e,antialias:!1,depth:!0,stencil:!1,powerPreference:`high-performance`}),this.renderer.setPixelRatio(1),this.renderer.shadowMap.enabled=!1,this.renderTarget=new Cn(480,270,{magFilter:I,minFilter:I,generateMipmaps:!1,depthBuffer:!0,stencilBuffer:!1}),this.renderTarget.texture.magFilter=I,this.renderTarget.texture.minFilter=I,this.renderTarget.texture.generateMipmaps=!1,this.backgroundTexture=Ol(),this.scene.background=this.backgroundTexture,this.camera=new Ha(50,c,l,u),this.camera.position.set(0,0,260),this.camera.lookAt(0,0,0),this.scene.add(new Ka(16777215,.45));let t=new Ga(16777215,.9);t.position.set(.35,.7,1),t.castShadow=!1,this.scene.add(t),this.quadMaterial=new pi({map:this.renderTarget.texture});let n=new Ti(new ta(2,2),this.quadMaterial);this.quadScene.add(n)}resize(e,t){this.renderer.setPixelRatio(1),this.renderer.setSize(e,t,!1),this.viewport=d(e,t)}getLetterbox(){return{...this.viewport}}applyView(e){this.camera.aspect=c,this.camera.fov=50,this.camera.near=e.near,this.camera.far=e.far,this.camera.position.set(e.position.x,e.position.y,e.position.z),this.camera.lookAt(e.target.x,e.target.y,e.target.z),this.camera.updateProjectionMatrix()}sync(e){let t=Nl(e,new Set(this.meshes.keys()));for(let e of t.remove)this.disposeMesh(e);for(let e of t.create)this.createMesh(e);for(let e of t.update)this.updateMesh(e);this.applyHighlight()}setSelection(e){this.selectedId=e,this.applyHighlight()}setToolPreview(e){if(e===null){this.clearToolPreview();return}if(this.clearToolPreview(),this.toolGhostMaterial=new pi({color:e.color,transparent:!0,opacity:Il,depthWrite:!1}),this.toolGhost=new Ti(this.sphereGeometry,this.toolGhostMaterial),this.toolGhost.position.set(e.position.x,e.position.y,e.position.z),this.toolGhost.scale.setScalar(e.radius),this.toolGhost.renderOrder=-1,this.scene.add(this.toolGhost),e.arrow!==null){let{from:t,to:n}=e.arrow,r=[t.x,t.y,t.z,n.x,n.y,n.z],i=n.x-t.x,a=n.y-t.y,o=n.z-t.z,s=Math.hypot(i,a,o);if(s>1e-9){let t=i/s,c=a/s,l=o/s,u=Math.abs(l)>.9?{x:1,y:0,z:0}:{x:0,y:0,z:1},d=c*u.z-l*u.y,f=l*u.x-t*u.z,p=t*u.y-c*u.x,m=Math.hypot(d,f,p);d/=m,f/=m,p/=m;let h=Math.cos(Fl),g=Math.sin(Fl),_=Math.max(s*.15,e.radius*.5,.2);for(let e of[1,-1]){let i=(-t*h+d*g*e)*_,a=(-c*h+f*g*e)*_,o=(-l*h+p*g*e)*_;r.push(n.x,n.y,n.z,n.x+i,n.y+a,n.z+o)}}this.toolArrowGeometry=new ni,this.toolArrowGeometry.setAttribute(`position`,new Wr(r,3)),this.toolArrowMaterial=new Li({color:Pl}),this.toolArrow=new Yi(this.toolArrowGeometry,this.toolArrowMaterial),this.scene.add(this.toolArrow)}}get toolPreviewActive(){return this.toolGhost!==null||this.toolArrow!==null}render(){let e=this.renderer;e.setRenderTarget(this.renderTarget),e.setViewport(0,0,480,270),e.setScissorTest(!1),e.render(this.scene,this.camera),e.setRenderTarget(null),e.setClearColor(this.clearColor,1),e.setViewport(0,0,e.domElement.width,e.domElement.height),e.setScissorTest(!1),e.clear();let{x:t,y:n,width:r,height:i}=this.viewport;e.setViewport(t,n,r,i),e.setScissor(t,n,r,i),e.setScissorTest(!0),e.render(this.quadScene,this.quadCamera),e.setScissorTest(!1)}get registeredIds(){return[...this.meshes.keys()].sort((e,t)=>e-t)}dispose(){this.clearToolPreview();for(let e of[...this.meshes.keys()])this.disposeMesh(e);this.sphereGeometry.dispose(),this.backgroundTexture.dispose(),this.quadMaterial.dispose(),this.renderTarget.dispose(),this.renderer.dispose()}createMesh(e){let t=new pa({color:e.color,emissive:Ll,emissiveIntensity:zl}),n=new Ti(this.sphereGeometry,t);n.castShadow=!1,n.receiveShadow=!1,n.position.set(e.position.x,e.position.y,e.position.z),n.scale.setScalar(e.radius),this.scene.add(n),this.meshes.set(e.id,{mesh:n,material:t})}updateMesh(e){let t=this.meshes.get(e.id);if(t===void 0){this.createMesh(e);return}t.mesh.position.set(e.position.x,e.position.y,e.position.z),t.mesh.scale.setScalar(e.radius),t.material.color.set(e.color)}applyHighlight(){for(let[e,t]of this.meshes){let n=e===this.selectedId;t.material.emissive.setHex(n?Rl:Ll),t.material.emissiveIntensity=n?Bl:zl}}clearToolPreview(){this.toolGhost!==null&&(this.scene.remove(this.toolGhost),this.toolGhost=null),this.toolGhostMaterial!==null&&(this.toolGhostMaterial.dispose(),this.toolGhostMaterial=null),this.toolArrow!==null&&(this.scene.remove(this.toolArrow),this.toolArrow=null),this.toolArrowGeometry!==null&&(this.toolArrowGeometry.dispose(),this.toolArrowGeometry=null),this.toolArrowMaterial!==null&&(this.toolArrowMaterial.dispose(),this.toolArrowMaterial=null)}disposeMesh(e){let t=this.meshes.get(e);t!==void 0&&(this.scene.remove(t.mesh),t.material.dispose(),this.meshes.delete(e))}};function Hl(e){let t=E(e.positionSim);return{position:t,radius:D(e.visualRadius),color:e.color,arrow:e.arrowEndSim===null?null:{from:t,to:E(e.arrowEndSim)}}}function Ul(e=0,t=0,n=0){return{x:e,y:t,z:n}}function Wl(e){return{x:e.x,y:e.y,z:e.z}}function Gl(e,t,n){e.x+=t.x*n,e.y+=t.y*n,e.z+=t.z*n}var Kl=66743e-33,ql=.001;function Jl(e,t){if(!Number.isFinite(e)||e<0)throw Error(`constante gravitationnelle invalide: ${e}`);if(!Number.isFinite(t)||t<0)throw Error(`softening invalide: ${t}`)}function Yl(e,t=Kl,n=ql){Jl(t,n);let r=e.map(()=>Ul());if(e.length<2||t===0)return r;let i=n*n;for(let n=0;n<e.length-1;n+=1){let a=e[n],o=r[n];if(a!==void 0&&o!==void 0)for(let s=n+1;s<e.length;s+=1){let n=e[s],c=r[s];if(n===void 0||c===void 0)continue;let l=n.position.x-a.position.x,u=n.position.y-a.position.y,d=n.position.z-a.position.z,f=l*l+u*u+d*d+i;if(!(f>0))continue;let p=1/(f*Math.sqrt(f)),m=t*n.mass*p,h=t*a.mass*p;o.x+=l*m,o.y+=u*m,o.z+=d*m,c.x-=l*h,c.y-=u*h,c.z-=d*h}}return r}function Xl(e,t,n=Kl,r=Ul(0,1,0)){if(!Number.isFinite(e)||e<0)throw Error(`masse centrale invalide: ${e}`);if(!Number.isFinite(t)||t<=0)throw Error(`distance orbitale invalide: ${t}`);if(!Number.isFinite(n)||n<0)throw Error(`constante gravitationnelle invalide: ${n}`);let i=Math.hypot(r.x,r.y,r.z);if(!(i>0)||!Number.isFinite(i))throw Error(`direction tangentielle invalide`);let a=Math.sqrt(n*e/t);return Ul(r.x/i*a,r.y/i*a,r.z/i*a)}function Zl(e,t,n){return{x:e.x+(t.x-e.x)*n,y:e.y+(t.y-e.y)*n,z:e.z+(t.z-e.z)*n}}function Ql(e,t,n,r,i,a){let o=r.x-e.x,s=r.y-e.y,c=r.z-e.z,l=i.x-r.x-(t.x-e.x),u=i.y-r.y-(t.y-e.y),d=i.z-r.z-(t.z-e.z),f=n+a,p=f*f,m=o*o+s*s+c*c,h;if(m<=p)h=0;else{let e=l*l+u*u+d*d;if(e>0){let t=o*l+s*u+c*d,n=m-p,r=t*t-e*n;if(r>=0){let n=(-t-Math.sqrt(r))/e;n>=0&&n<=1&&(h=n)}}}if(h===void 0)return;let g=Zl(e,t,h),_=Zl(r,i,h);return{timeOfImpact:h,position:{x:.5*(g.x+_.x),y:.5*(g.y+_.y),z:.5*(g.z+_.z)}}}function $l(e,t){let n=[];for(let r of e){let e=t.get(r.id);e!==void 0&&n.push({body:r,start:e,minX:Math.min(e.x,r.position.x)-r.physicalRadius,maxX:Math.max(e.x,r.position.x)+r.physicalRadius,minY:Math.min(e.y,r.position.y)-r.physicalRadius,maxY:Math.max(e.y,r.position.y)+r.physicalRadius,minZ:Math.min(e.z,r.position.z)-r.physicalRadius,maxZ:Math.max(e.z,r.position.z)+r.physicalRadius})}n.sort((e,t)=>e.minX===t.minX?e.body.id-t.body.id:e.minX-t.minX);let r=[];for(let e=0;e<n.length-1;e+=1){let t=n[e];if(t!==void 0)for(let i=e+1;i<n.length;i+=1){let e=n[i];if(e===void 0)continue;if(e.minX>t.maxX)break;if(t.maxY<e.minY||e.maxY<t.minY||t.maxZ<e.minZ||e.maxZ<t.minZ)continue;let a=Ql(t.start,t.body.position,t.body.physicalRadius,e.start,e.body.position,e.body.physicalRadius);a!==void 0&&r.push({bodyAId:t.body.id,bodyBId:e.body.id,timeOfImpact:a.timeOfImpact,position:a.position})}}return r.sort((e,t)=>e.bodyAId===t.bodyAId?e.bodyBId-t.bodyBId:e.bodyAId-t.bodyAId),r}function eu(e,t,n,r,i,a,o){return Object.freeze(r),Object.freeze({bodyAId:e,bodyBId:t,resultingBodyId:n,position:r,energy:i,massA:a,massB:o})}var tu=class e{seed;gravitationalConstant;softening;bodies=new Map;collisionEvents=[];accelerations;nextId=1;simTime=0;constructor(e={}){if(this.seed=e.seed??0,this.gravitationalConstant=e.gravitationalConstant??66743e-33,this.softening=e.softening??.001,!Number.isFinite(this.gravitationalConstant)||this.gravitationalConstant<0)throw Error(`constante gravitationnelle invalide: ${this.gravitationalConstant}`);if(!Number.isFinite(this.softening)||this.softening<0)throw Error(`softening invalide: ${this.softening}`)}get time(){return this.simTime}get nextBodyId(){return this.nextId}static hydrate(t){if(!Number.isFinite(t.nextId)||t.nextId<1)throw Error(`prochain id invalide: ${t.nextId}`);if(!Number.isFinite(t.time)||t.time<0)throw Error(`temps simulé invalide: ${t.time}`);let n=new e({seed:t.seed,gravitationalConstant:t.gravitationalConstant,softening:t.softening}),r=0;for(let e of t.bodies){if(!Number.isInteger(e.id)||e.id<1||!Number.isFinite(e.id))throw Error(`id de corps invalide: ${e.id}`);if(r>=e.id)throw Error(`ids de corps non triés ou dupliqués: ${e.id}`);if(r=e.id,!(e.mass>0))throw Error(`masse invalide pour le corps ${e.id}: ${e.mass}`);if(!(e.physicalRadius>0))throw Error(`rayon physique invalide pour le corps ${e.id}: ${e.physicalRadius}`);if(!(e.visualRadius>0))throw Error(`rayon visuel invalide pour le corps ${e.id}: ${e.visualRadius}`);let t={id:e.id,category:e.category,name:e.name,mass:e.mass,physicalRadius:e.physicalRadius,visualRadius:e.visualRadius,position:Wl(e.position),velocity:Wl(e.velocity),visualColor:e.visualColor};n.bodies.set(t.id,t)}if(t.nextId<=r)throw Error(`prochain id ${t.nextId} doit être strictement supérieur au plus grand id existant ${r}`);return n.nextId=t.nextId,n.simTime=t.time,n.accelerations=void 0,n}get bodyCount(){return this.bodies.size}getBody(e){return this.bodies.get(e)}listBodies(){return[...this.bodies.values()]}addBody(e){if(!(e.mass>0))throw Error(`masse invalide: ${e.mass}`);if(!(e.physicalRadius>0))throw Error(`rayon physique invalide: ${e.physicalRadius}`);if(!(e.visualRadius>0))throw Error(`rayon visuel invalide: ${e.visualRadius}`);let t=this.nextId;this.nextId+=1;let n={id:t,category:e.category,name:e.name??`body-${t}`,mass:e.mass,physicalRadius:e.physicalRadius,visualRadius:e.visualRadius,position:Wl(e.position),velocity:Wl(e.velocity),visualColor:e.visualColor};return this.bodies.set(t,n),this.accelerations=void 0,n}removeBody(e){return this.bodies.delete(e)?(this.accelerations=void 0,this.collisionEvents.length>0&&(this.collisionEvents=this.collisionEvents.filter(t=>t.bodyAId!==e&&t.bodyBId!==e&&t.resultingBodyId!==e)),!0):!1}setBodyMass(e,t){if(!Number.isFinite(t)||!(t>0))throw Error(`masse invalide: ${t}`);let n=this.bodies.get(e);if(n===void 0)throw Error(`corps inexistant: ${e}`);n.mass=t,this.accelerations=void 0}setBodyRadii(e,t,n){if(!Number.isFinite(t)||!(t>0))throw Error(`rayon physique invalide: ${t}`);if(!Number.isFinite(n)||!(n>0))throw Error(`rayon visuel invalide: ${n}`);let r=this.bodies.get(e);if(r===void 0)throw Error(`corps inexistant: ${e}`);r.physicalRadius=t,r.visualRadius=n}setBodyVelocity(e,t){if(!Number.isFinite(t.x)||!Number.isFinite(t.y)||!Number.isFinite(t.z))throw Error(`vélocité invalide: ${JSON.stringify(t)}`);let n=this.bodies.get(e);if(n===void 0)throw Error(`corps inexistant: ${e}`);n.velocity.x=t.x,n.velocity.y=t.y,n.velocity.z=t.z}drainEvents(){let e=this.collisionEvents;return this.collisionEvents=[],e}step(e){if(!(e>=0))throw Error(`dt invalide: ${e}`);if(e===0)return;let t=[...this.bodies.values()],n=new Map;for(let e of t)n.set(e.id,Wl(e.position));let r=this.accelerations??this.accelerationMap(t,Yl(t,this.gravitationalConstant,this.softening)),i=.5*e*e;for(let n of t){let t=r.get(n.id);if(t===void 0){Gl(n.position,n.velocity,e);continue}n.position.x+=n.velocity.x*e+t.x*i,n.position.y+=n.velocity.y*e+t.y*i,n.position.z+=n.velocity.z*e+t.z*i}let a=Yl(t,this.gravitationalConstant,this.softening);for(let n=0;n<t.length;n+=1){let i=t[n],o=i===void 0?void 0:r.get(i.id),s=a[n];if(i===void 0||o===void 0||s===void 0)continue;let c=.5*e;i.velocity.x+=(o.x+s.x)*c,i.velocity.y+=(o.y+s.y)*c,i.velocity.z+=(o.z+s.z)*c}let o=$l(t,n),s=this.resolveCollisions(o);if(s.size>0){for(let e of s)this.bodies.delete(e);let e=[...this.bodies.values()];this.accelerations=this.accelerationMap(e,Yl(e,this.gravitationalConstant,this.softening))}else this.accelerations=this.accelerationMap(t,a);this.simTime+=e}resolveCollisions(e){let t=new Set,n=new Set;for(let r of e){if(t.has(r.bodyAId)||t.has(r.bodyBId))continue;let e=this.bodies.get(r.bodyAId),i=this.bodies.get(r.bodyBId);if(e===void 0||i===void 0)continue;let a=e.id<i.id?e:i,o=a===e?i:e,s=e.mass,c=i.mass,l=s+c,u=s*c/l,d=i.velocity.x-e.velocity.x,f=i.velocity.y-e.velocity.y,p=i.velocity.z-e.velocity.z,m=.5*u*(d*d+f*f+p*p);a.position.x=(s*e.position.x+c*i.position.x)/l,a.position.y=(s*e.position.y+c*i.position.y)/l,a.position.z=(s*e.position.z+c*i.position.z)/l,a.velocity.x=(s*e.velocity.x+c*i.velocity.x)/l,a.velocity.y=(s*e.velocity.y+c*i.velocity.y)/l,a.velocity.z=(s*e.velocity.z+c*i.velocity.z)/l,a.mass=l,a.physicalRadius=Math.cbrt(e.physicalRadius**3+i.physicalRadius**3),a.visualRadius=Math.cbrt(e.visualRadius**3+i.visualRadius**3),t.add(e.id),t.add(i.id),n.add(o.id),this.collisionEvents.push(eu(r.bodyAId,r.bodyBId,a.id,r.position,m,s,c))}return n}accelerationMap(e,t){let n=new Map;for(let r=0;r<e.length;r+=1){let i=e[r],a=t[r];i!==void 0&&a!==void 0&&n.set(i.id,a)}return n}getSnapshot(){let e=[];for(let t of this.bodies.values()){let n={id:t.id,category:t.category,name:t.name,mass:t.mass,physicalRadius:t.physicalRadius,visualRadius:t.visualRadius,position:Wl(t.position),velocity:Wl(t.velocity)};t.visualColor!==void 0&&(n.visualColor=t.visualColor),Object.freeze(n.position),Object.freeze(n.velocity),Object.freeze(n),e.push(n)}let t={seed:this.seed,time:this.simTime,bodies:e};return Object.freeze(t.bodies),Object.freeze(t),t}},nu=[`star`,`planet`,`asteroid`],ru=class extends Error{constructor(e){super(e),this.name=`SceneValidationError`}};function $(e,t){throw new ru(`${e}: ${t}`)}function iu(e){return typeof e==`object`&&!!e&&!Array.isArray(e)}function au(e,t){return iu(e)||$(t,`objet attendu`),e}function ou(e,t,n){let r=e[t];return r===void 0&&$(n,`champ obligatoire manquant: "${t}"`),(typeof r!=`number`||!Number.isFinite(r))&&$(n,`"${t}" doit être un nombre fini (reçu: ${JSON.stringify(r)??String(r)})`),r}function su(e,t,n){let r=ou(e,t,n);return r>0||$(n,`"${t}" doit être strictement positif (reçu: ${r})`),r}function cu(e,t,n){let r=e[t];return r===void 0&&$(n,`champ obligatoire manquant: "${t}"`),(typeof r!=`string`||r.trim().length===0)&&$(n,`"${t}" doit être une chaîne non vide`),r}function lu(e,t,n){let r=e[t];if(r!==void 0)return(typeof r!=`string`||r.trim().length===0)&&$(n,`"${t}" doit être une chaîne non vide si présent`),r}function uu(e,t){let n=au(e,t);return{x:ou(n,`x`,t),y:ou(n,`y`,t),z:ou(n,`z`,t)}}function du(e,t,n){let r=e[t];return r===void 0&&$(n,`champ obligatoire manquant: "${t}"`),uu(r,`${n}.${t}`)}function fu(e,t){return(typeof e!=`number`||!Number.isInteger(e)||e<1)&&$(t,`identifiant attendu entier >= 1 (reçu: ${JSON.stringify(e)??String(e)})`),e}function pu(e,t){let n=au(e,t),r=n.kind;if(r===void 0&&$(`${t}.kind`,`champ obligatoire manquant: "kind"`),r===`cartesian`)return{kind:`cartesian`,position:du(n,`position`,t),velocity:du(n,`velocity`,t)};if(r===`circular-orbit`){let e={kind:`circular-orbit`,centralBodyId:fu(n.centralBodyId,`${t}.centralBodyId`),radius:su(n,`radius`,t)},r=n.tangentDirection;if(r!==void 0){let n=uu(r,`${t}.tangentDirection`),i=Math.hypot(n.x,n.y,n.z);(!(i>0)||!Number.isFinite(i))&&$(`${t}.tangentDirection`,`direction tangentielle non nulle requise`),e.tangentDirection=n}return e}$(`${t}.kind`,`type d'état initial inconnu: ${JSON.stringify(r)??String(r)}`)}function mu(e){let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch(e){throw new ru(`JSON invalide: ${e instanceof Error?e.message:String(e)}`)}let n=au(t,`scene`),r=n.version;r===void 0&&$(`scene`,`champ obligatoire manquant: "version"`),(typeof r!=`number`||!Number.isInteger(r))&&$(`scene.version`,`entier attendu (reçu: ${JSON.stringify(r)??String(r)})`),r!==1&&$(`scene.version`,`version de format inconnue: ${r} (supportée: 1)`);let i=n.metadata;i===void 0&&$(`scene`,`champ obligatoire manquant: "metadata"`);let a=au(i,`scene.metadata`),o={name:cu(a,`name`,`scene.metadata`),description:lu(a,`description`,`scene.metadata`)},s=n.physics;s===void 0&&$(`scene`,`champ obligatoire manquant: "physics"`);let c=au(s,`scene.physics`),l=ou(c,`gravitationalConstant`,`scene.physics`);l>=0||$(`scene.physics.gravitationalConstant`,`doit être >= 0 (reçu: ${l})`);let u=ou(c,`softening`,`scene.physics`);u>=0||$(`scene.physics.softening`,`doit être >= 0 (reçu: ${u})`);let d={gravitationalConstant:l,softening:u,dt:su(c,`dt`,`scene.physics`)},f=n.seed??0;(typeof f!=`number`||!Number.isFinite(f))&&$(`scene.seed`,`doit être un nombre fini`);let p=n.bodies;p===void 0&&$(`scene`,`champ obligatoire manquant: "bodies"`),Array.isArray(p)||$(`scene.bodies`,`tableau attendu`),p.length===0&&$(`scene.bodies`,`au moins un corps est requis`);let m=new Set,h=[];for(let e=0;e<p.length;e+=1){let t=p[e],n=`scene.bodies[${e}]`,r=au(t,n),i=fu(r.id,`${n}.id`);m.has(i)&&$(`${n}.id`,`identifiant dupliqué: ${i}`),m.add(i);let a=r.category;a===void 0&&$(`${n}.category`,`champ obligatoire manquant: "category"`),(typeof a!=`string`||!nu.includes(a))&&$(`${n}.category`,`catégorie inconnue: ${JSON.stringify(a)??String(a)} (autorisées: ${nu.join(`, `)})`);let o=r.initialState;o===void 0&&$(n,`champ obligatoire manquant: "initialState"`),h.push({id:i,category:a,name:lu(r,`name`,n),mass:su(r,`mass`,n),physicalRadius:su(r,`physicalRadius`,n),visualRadius:su(r,`visualRadius`,n),visualColor:lu(r,`visualColor`,n),initialState:pu(o,`${n}.initialState`)})}let g=h.map(e=>e.id);for(let e=0;e<h.length;e+=1){let t=h[e];if(t===void 0||t.initialState.kind!==`circular-orbit`)continue;let n=`scene.bodies[${e}].initialState`,r=g.indexOf(t.initialState.centralBodyId);r===-1&&$(n,`corps central inexistant: ${t.initialState.centralBodyId}`),r>=e&&$(n,`le corps central ${t.initialState.centralBodyId} doit être défini avant le corps ${t.id}`)}return{version:r,metadata:o,physics:d,seed:f,bodies:h}}function hu(e){let t=e.initialState;return t.kind===`cartesian`?Ul(t.position.x,t.position.y,t.position.z):Ul(t.radius,0,0)}function gu(e,t){let n=e.initialState;if(n.kind===`cartesian`)return Ul(n.velocity.x,n.velocity.y,n.velocity.z);let r=t.getBody(n.centralBodyId);if(r===void 0)throw new ru(`bodies[${e.id}].initialState: corps central inexistant: ${n.centralBodyId}`);return Xl(r.mass,n.radius,t.gravitationalConstant,n.tangentDirection??Ul(0,1,0))}function _u(e){let t=new tu({seed:e.seed,gravitationalConstant:e.physics.gravitationalConstant,softening:e.physics.softening});for(let n of e.bodies){let e={category:n.category,name:n.name,mass:n.mass,physicalRadius:n.physicalRadius,visualRadius:n.visualRadius,position:hu(n),velocity:gu(n,t),visualColor:n.visualColor};t.addBody(e)}return{world:t,dt:e.physics.dt,scene:e}}var vu=1/120,yu=class{fixedDt;maxStepsPerUpdate;accumulator=0;constructor(e=vu,t=4096){if(!(e>0))throw Error(`fixedDt invalide: ${e}`);if(!(t>0))throw Error(`maxStepsPerUpdate invalide: ${t}`);this.fixedDt=e,this.maxStepsPerUpdate=t}get dt(){return this.fixedDt}get pendingTime(){return this.accumulator}update(e,t){if(!(e>=0))throw Error(`elapsed invalide: ${e}`);this.accumulator+=e;let n=0;for(;this.accumulator>=this.fixedDt&&n<this.maxStepsPerUpdate;)t(this.fixedDt),this.accumulator-=this.fixedDt,n+=1;return this.accumulator>=this.fixedDt&&(this.accumulator=0),n}},bu={star:`étoile`,planet:`planète`,asteroid:`astéroïde`};function xu(e,t=3){return Number.isFinite(e)?e.toExponential(t):`—`}function Su(e,t=3){return Number.isFinite(e)?e.toFixed(t):`—`}function Cu(e){return Math.hypot(e.x,e.y,e.z)}function wu(e){return Math.hypot(e.x,e.y,e.z)}function Tu(e){return e===null?{kind:`empty`}:{kind:`body`,fields:{name:e.name,category:bu[e.category],mass:`${xu(e.mass)} kg`,physicalRadius:`${Su(e.physicalRadius)} Mm`,visualRadius:`${Su(e.visualRadius)} Mm`,speed:`${xu(wu(e.velocity))} Mm/s`,distance:`${Su(Cu(e.position))} Mm`}}}function Eu(e,t){if(t===null)return null;for(let n of e.bodies)if(n.id===t)return n;return null}var Du=`<p class="empty">Aucune sélection</p>`;function Ou(e){return e.replaceAll(`&`,`&amp;`).replaceAll(`<`,`&lt;`).replaceAll(`>`,`&gt;`).replaceAll(`"`,`&quot;`)}function ku(e){return`<dl>
  <dt>Nom</dt><dd>${Ou(e.name)}</dd>
  <dt>Catégorie</dt><dd>${Ou(e.category)}</dd>
  <dt>Masse</dt><dd>${Ou(e.mass)}</dd>
  <dt>Rayon</dt><dd>${Ou(e.physicalRadius)}</dd>
  <dt>Rayon visuel</dt><dd>${Ou(e.visualRadius)}</dd>
  <dt>Vitesse</dt><dd>${Ou(e.speed)}</dd>
  <dt>Distance</dt><dd>${Ou(e.distance)}</dd>
</dl>`}function Au(e,t){e.innerHTML=t.kind===`empty`?Du:ku(t.fields)}function ju(e,t,n){Au(e,Tu(Eu(t,n)))}function Mu(e=null){let t=e;return{getId(){return t},setId(e){t=e},clear(){t=null},sync(e){if(t===null)return null;for(let n of e.bodies)if(n.id===t)return t;return t=null,null}}}var Nu=[0,1,10,100];function Pu(e){return e===0||e===1||e===10||e===100}function Fu(e,t){return e*t}function Iu(e){return e===0?`Pause`:`×${e}`}function Lu(e,t,n,r){return e.update(Fu(t,n),r)}function Ru(e){return e===0?`Pause`:`×${e}`}function zu(e,t,n){let r=t,i=new Map,a=()=>{for(let[e,t]of i){let n=e===r;t.classList.toggle(`active`,n),t.setAttribute(`aria-pressed`,n?`true`:`false`)}},o=e=>{let t=e.target;if(!(t instanceof HTMLButtonElement))return;let i=Number(t.dataset.scale);Pu(i)&&(r=i,a(),n?.(r))};e.addEventListener(`click`,o);let s=e.querySelectorAll(`button[data-scale]`);if(s.length>0)for(let e of s){if(!(e instanceof HTMLButtonElement))continue;let t=Number(e.dataset.scale);Pu(t)&&i.set(t,e)}else for(let t of Nu){let n=document.createElement(`button`);n.type=`button`,n.dataset.scale=String(t),n.textContent=Ru(t),e.append(n),i.set(t,n)}return a(),{getScale:()=>r,setScale:e=>{r=e,a(),n?.(r)},dispose:()=>{e.removeEventListener(`click`,o),e.replaceChildren()}}}function Bu(e){return e.setAttribute(`aria-hidden`,`true`),{show:(t,n,r)=>{e.textContent=t,e.style.left=`${n+12}px`,e.style.top=`${r+12}px`,e.hidden=!1,e.setAttribute(`aria-hidden`,`false`)},hide:()=>{e.hidden=!0,e.textContent=``,e.setAttribute(`aria-hidden`,`true`)}}}function Vu(e=`planet`){let t=`navigate`,n=e,r=null,i=()=>{r=null},a=e=>{let t=e.endHit??e.startHit;return pe(e.pose,e.startHit,t)},o=e=>{let t=e.endHit??e.startHit;return Math.hypot(t.x-e.startHit.x,t.y-e.startHit.y)<5?null:de(e.pose,t)};return{getMode:()=>t,setMode(e){e!==t&&(e===`navigate`&&i(),t=e)},toggleMode(){t=t===`navigate`?`create`:`navigate`,t===`navigate`&&i()},getPresetId:()=>n,setPreset(e){n=e},hasGesture:()=>r!==null,beginGesture(e,n){if(t!==`create`||r!==null)return!1;let i=de(n,e);return i!==null&&(r={startHit:e,pose:n,positionScene:i,endHit:null},!0)},moveGesture(e){r!==null&&(r.endHit=e)},endGesture(e,t){let o=r;if(i(),o===null||t)return null;e!==null&&(o.endHit=e);let s=me(a(o)),c=me(o.positionScene);return{spec:he(ce(n),c,s)}},cancelGesture(){i()},getPreview(){let e=r;if(e===null)return null;let t=ce(n),i=me(a(e)),s=o(e);return{positionSim:me(e.positionScene),visualRadius:t.visualRadius,color:t.visualColor,speedMmPerS:Math.hypot(i.x,i.y,i.z),arrowEndSim:s===null?null:me(s)}}}}var Hu={star:`Etoile`,planet:`Planete`,asteroid:`Asteroide`,navigate:`Nav`};function Uu(e){return e===`star`||e===`planet`||e===`asteroid`||e===`navigate`}function Wu(e,t,n){let r=t,i=new Map,a=()=>{for(let[e,t]of i){let n=e===r;t.classList.toggle(`active`,n),t.setAttribute(`aria-pressed`,n?`true`:`false`)}},o=e=>{let t=e.target;if(!(t instanceof HTMLButtonElement))return;let i=t.dataset.preset;i===void 0||!Uu(i)||(r=i,a(),n?.(r))};e.addEventListener(`click`,o);let s=e.querySelectorAll(`button[data-preset]`);if(s.length>0)for(let e of s){if(!(e instanceof HTMLButtonElement))continue;let t=e.dataset.preset;t!==void 0&&Uu(t)&&i.set(t,e)}else for(let t of[`navigate`,`star`,`planet`,`asteroid`]){let n=document.createElement(`button`);n.type=`button`,n.dataset.preset=t,n.textContent=Hu[t],e.append(n),i.set(t,n)}return a(),{getChoice:()=>r,setChoice:e=>{r=e,a()},dispose:()=>{e.removeEventListener(`click`,o),e.replaceChildren()}}}function Gu(e){return!Number.isFinite(e)||e<=0?21:Math.min(Math.max(Math.log10(e),15),27)}function Ku(e){return 10**Math.min(Math.max(e,15),27)}function qu(e,t,n){if(!(e>0)||!(t>0)||!(n>0))return Math.min(n,24);let r=t/e*n;return Math.min(r>0?r:n,24)}function Ju(e,t){if(!Number.isFinite(t)||t<=0)throw Error(`facteur d'echelle invalide: ${t}`);let n=Math.hypot(e.x,e.y,e.z);if(!(n>0)||!Number.isFinite(n))return{x:0,y:0,z:0};let r=n*t;return{x:e.x/n*r,y:e.y/n*r,z:e.z/n*r}}var Yu=.1,Xu=20,Zu=[.5,1,1.5,2];function Qu(e,t){let n=document.createElement(`dt`);n.textContent=`Masse`;let r=document.createElement(`dd`),i=document.createElement(`input`);i.type=`range`,i.min=`15`,i.max=`27`,i.step=`0.1`,i.setAttribute(`aria-label`,`edition masse`),i.addEventListener(`change`,()=>{let e=Number(i.dataset.bodyId);e>0&&t({kind:`mass`,id:e,mass:Ku(Number(i.value))})});let a=document.createElement(`dt`);a.textContent=`Rayon`;let o=document.createElement(`dd`),s=document.createElement(`input`);s.type=`range`,s.min=String(Yu),s.max=String(Xu),s.step=`0.1`,s.setAttribute(`aria-label`,`edition rayon`),s.addEventListener(`change`,()=>{let e=Number(s.dataset.bodyId),n=Number(s.value);e>0&&t({kind:`radii`,id:e,physicalRadius:n,visualRadius:qu(Number(s.dataset.currentPhysical),Number(s.dataset.visualRadius),n)})});let c=document.createElement(`dt`);c.textContent=`Vitesse`;let l=document.createElement(`dd`),u=document.createElement(`select`);u.setAttribute(`aria-label`,`facteur velocite`);for(let e of Zu){let t=document.createElement(`option`);t.value=String(e),t.textContent=`x`+e,u.appendChild(t)}u.addEventListener(`change`,()=>{let e=Number(u.dataset.bodyId);e>0&&t({kind:`velocity`,id:e,velocity:Ju({x:Number(u.dataset.vx),y:Number(u.dataset.vy),z:Number(u.dataset.vz)},Number(u.value))})});let d=document.createElement(`button`);d.type=`button`,d.textContent=`Supprimer`,d.setAttribute(`aria-label`,`supprimer le corps selectionne`),d.addEventListener(`click`,()=>{let e=Number(d.dataset.bodyId);e>0&&t({kind:`remove`,id:e})});let f=document.createElement(`dl`);f.className=`edit`,f.append(n,r,i,a,o,s,c,l,u);let p=document.createElement(`div`);p.className=`edit-actions`,p.appendChild(d),e.replaceChildren(f,p),e.hidden=!1;let m=[i,s,u,d],h=null,g=(e,t,n,a,c,f,p)=>{i.dataset.bodyId=String(e),i.value=String(Gu(t)),r.textContent=$u(t),s.dataset.bodyId=String(e),s.dataset.visualRadius=String(a),s.dataset.currentPhysical=String(n),s.value=String(Math.min(Math.max(n,Yu),Xu)),o.textContent=$u(n),u.dataset.bodyId=String(e),u.dataset.vx=String(c),u.dataset.vy=String(f),u.dataset.vz=String(p),l.textContent=$u(Math.hypot(c,f,p)),d.dataset.bodyId=String(e)},_=(e,t,n,a,c,f,p)=>{i.dataset.bodyId=String(e),s.dataset.bodyId=String(e),s.dataset.visualRadius=String(a),s.dataset.currentPhysical=String(n),u.dataset.bodyId=String(e),u.dataset.vx=String(c),u.dataset.vy=String(f),u.dataset.vz=String(p),r.textContent=$u(t),o.textContent=$u(n),l.textContent=$u(Math.hypot(c,f,p)),d.dataset.bodyId=String(e)};return{update(t,n,r){if(n===null){e.hidden=!0,h=null;return}let i=Eu(t,n);if(i===null){e.hidden=!0,h=null;return}e.hidden=!1;for(let e of m)e.disabled=!r;h===n?_(i.id,i.mass,i.physicalRadius,i.visualRadius,i.velocity.x,i.velocity.y,i.velocity.z):(g(i.id,i.mass,i.physicalRadius,i.visualRadius,i.velocity.x,i.velocity.y,i.velocity.z),h=n)},dispose(){e.replaceChildren(),e.hidden=!0}}}function $u(e){if(!Number.isFinite(e))return`-`;if(e===0)return`0`;let t=Math.abs(e);return t>=1e6||t<.01?e.toExponential(2):String(parseFloat(e.toPrecision(3)))}var ed=document.getElementById(`scene`),td=document.getElementById(`hud`),nd=document.getElementById(`info-panel`),rd=document.getElementById(`edit-panel`),id=document.getElementById(`time-bar`),ad=document.getElementById(`tooltip`),od=document.getElementById(`tool-bar`);if(!(ed instanceof HTMLCanvasElement)||!(td instanceof HTMLElement)||!(nd instanceof HTMLElement)||!(rd instanceof HTMLElement)||!(id instanceof HTMLElement)||!(ad instanceof HTMLElement)||!(od instanceof HTMLElement))throw Error(`DOM initialisation manquante`);var sd=_u(mu(e)),cd=new Vl(ed),ld=new O,ud=new yu(sd.dt),dd=Mu(),fd=Bu(ad),pd=zu(id,1),md=Vu(`planet`),hd=Qu(rd,e=>{let t=dd.getId();if(e.id===t&&sd.world.getBody(e.id)!==void 0){if(e.kind===`mass`){sd.world.setBodyMass(e.id,e.mass);return}if(e.kind===`radii`){sd.world.setBodyRadii(e.id,e.physicalRadius,e.visualRadius);return}if(e.kind===`velocity`){sd.world.setBodyVelocity(e.id,e.velocity);return}e.kind===`remove`&&(ld.getFollowedId()===e.id&&ld.followTarget(null),sd.world.removeBody(e.id),dd.clear())}}),gd=()=>{cd.resize(window.innerWidth,window.innerHeight)};window.addEventListener(`resize`,gd),gd();var _d=Wu(od,`navigate`,e=>{e===`navigate`?md.setMode(`navigate`):(md.setPreset(e),md.setMode(`create`))}),vd=()=>{_d.setChoice(md.getMode()===`create`?md.getPresetId():`navigate`)};se(ed,ld,()=>cd.getLetterbox(),()=>ld.getPose(),()=>sd.world.getSnapshot(),{onSelect:e=>{dd.setId(e)},onHover:(e,t,n)=>{if(e===null){fd.hide();return}fd.show(e,t,n)},toolMode:()=>md.getMode(),onToolBegin:e=>{md.beginGesture(e,ld.getPose())},onToolMove:e=>{md.moveGesture(e)},onToolEnd:(e,t)=>{let n=md.endGesture(e,t);if(n===null)return;let r=sd.world.addBody(n.spec);dd.setId(r.id)}}),window.addEventListener(`keydown`,e=>{let t=document.activeElement;if(!(t instanceof HTMLElement&&rd.contains(t))){if(e.code===`Space`){e.preventDefault();let t=pd.getScale();pd.setScale(+(t===0));return}if(e.key===`1`||e.key===`2`||e.key===`3`){let t=e.key===`1`?1:e.key===`2`?10:100;Pu(t)&&pd.setScale(t);return}if(!(e.ctrlKey||e.altKey||e.metaKey)){if(e.code===`KeyE`){md.toggleMode(),vd();return}e.key===`Escape`&&(md.hasGesture()?md.cancelGesture():md.setMode(`navigate`),vd())}}});var yd=sd.world.getSnapshot();ld.followTarget(A(yd)??1),cd.sync(yd),ld.update(yd,0),cd.applyView(ld.getPose());var bd=performance.now(),xd=60,Sd=e=>{let t=Math.max(0,(e-bd)/1e3);bd=e,t>0&&(xd+=(1/t-xd)*.1);let n=pd.getScale();Lu(ud,t,n,e=>{sd.world.step(e)});let r=sd.world.getSnapshot(),i=dd.sync(r);cd.sync(r),cd.setSelection(i);let a=md.getPreview();cd.setToolPreview(a===null?null:Hl(a)),ld.update(r,t),cd.applyView(ld.getPose()),cd.render(),sd.world.drainEvents(),ju(nd,r,i);let o=md.getMode()===`navigate`&&!md.hasGesture();hd.update(r,i,o);let s=md.getMode()===`create`?`outil `+md.getPresetId():`nav`;td.textContent=`DEMIURGE - phase 9 · `+Math.round(xd)+` fps · `+Iu(n)+` · `+s,requestAnimationFrame(Sd)};requestAnimationFrame(Sd);